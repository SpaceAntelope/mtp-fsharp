...
module PDHeader = 
    ...
    let GUID_DEVINTERFACE_WPD = 
        new System.Guid(0x6AC27878u, 0xA6FAus, 0x4155us, 0xBAuy, 0x85uy, 0xF9uy, 0x8Fuy, 0x49uy, 0x1Duy, 0x4Fuy, 0x33uy)
    ...
    let GUID_DEVINTERFACE_WPD_PRIVATE = 
        new System.Guid(0xBA0C718Fu, 0x4DEDus, 0x49B7us, 0xBDuy, 0xD3uy, 0xFAuy, 0xBEuy, 0x28uy, 0x66uy, 0x12uy, 0x11uy)
    ...
    let GUID_DEVINTERFACE_WPD_SERVICE = 
        new System.Guid(0x9EF44F80u, 0x3D64us, 0x4246us, 0xA6uy, 0xAAuy, 0x20uy, 0x6Fuy, 0x32uy, 0x8Duy, 0x1Euy, 0xDCuy)
    ...
    let WPD_EVENT_NOTIFICATION = 
        new System.Guid(0x2BA2E40Au, 0x6B4Cus, 0x4295us, 0xBBuy, 0x43uy, 0x26uy, 0x32uy, 0x2Buy, 0x99uy, 0xAEuy, 0xB2uy)
    
    ///
    /// WPD_EVENT_OBJECT_ADDED
    ///   This event is sent after a new object is available on the device.
    let WPD_EVENT_OBJECT_ADDED = 
        new System.Guid(0xA726DA95u, 0xE207us, 0x4B02us, 0x8Duy, 0x44uy, 0xBEuy, 0xF2uy, 0xE8uy, 0x6Cuy, 0xBFuy, 0xFCuy)
    
    ///
    /// WPD_EVENT_OBJECT_REMOVED
    ///   This event is sent after a previously existing object has been removed from the device.
    let WPD_EVENT_OBJECT_REMOVED = 
        new System.Guid(0xBE82AB88u, 0xA52Cus, 0x4823us, 0x96uy, 0xE5uy, 0xD0uy, 0x27uy, 0x26uy, 0x71uy, 0xFCuy, 0x38uy)
    ...
    let WPD_EVENT_OBJECT_UPDATED = 
        new System.Guid(0x1445A759u, 0x2E01us, 0x485Dus, 0x9Fuy, 0x27uy, 0xFFuy, 0x07uy, 0xDAuy, 0xE6uy, 0x97uy, 0xABuy)
    ...
    let WPD_EVENT_DEVICE_RESET = 
        new System.Guid(0x7755CF53u, 0xC1EDus, 0x44F3us, 0xB5uy, 0xA2uy, 0x45uy, 0x1Euy, 0x2Cuy, 0x37uy, 0x6Buy, 0x27uy)
    ...
    let WPD_EVENT_DEVICE_CAPABILITIES_UPDATED = 
        new System.Guid(0x36885AA1u, 0xCD54us, 0x4DAAus, 0xB3uy, 0xD0uy, 0xAFuy, 0xB3uy, 0xE0uy, 0x3Fuy, 0x59uy, 0x99uy)
    
    ///
    /// WPD_EVENT_STORAGE_FORMAT
    ///   This event indicates the progress of a format operation on a storage object.
    let WPD_EVENT_STORAGE_FORMAT = 
        new System.Guid(0x3782616Bu, 0x22BCus, 0x4474us, 0xA2uy, 0x51uy, 0x30uy, 0x70uy, 0xF8uy, 0xD3uy, 0x88uy, 0x57uy)
    ...
    let WPD_EVENT_OBJECT_TRANSFER_REQUESTED = 
        new System.Guid(0x8D16A0A1u, 0xF2C6us, 0x41DAus, 0x8Fuy, 0x19uy, 0x5Euy, 0x53uy, 0x72uy, 0x1Auy, 0xDBuy, 0xF2uy)
    ...
    let WPD_EVENT_DEVICE_REMOVED = 
        new System.Guid(0xE4CBCA1Bu, 0x6918us, 0x48B9us, 0x85uy, 0xEEuy, 0x02uy, 0xBEuy, 0x7Cuy, 0x85uy, 0x0Auy, 0xF9uy)
    ...
    let WPD_EVENT_SERVICE_METHOD_COMPLETE = 
        new System.Guid(0x8A33F5F8u, 0x0ACCus, 0x4D9Bus, 0x9Cuy, 0xC4uy, 0x11uy, 0x2Duy, 0x35uy, 0x3Buy, 0x86uy, 0xCAuy)
    ...
    let WPD_CONTENT_TYPE_FUNCTIONAL_OBJECT = 
        new System.Guid(0x99ED0160u, 0x17FFus, 0x4C44us, 0x9Duy, 0x98uy, 0x1Duy, 0x7Auy, 0x6Fuy, 0x94uy, 0x19uy, 0x21uy)
    
    ///
    /// WPD_CONTENT_TYPE_FOLDER
    ///   Indicates this object is a folder.
    let WPD_CONTENT_TYPE_FOLDER = 
        new System.Guid(0x27E2E392u, 0xA111us, 0x48E0us, 0xABuy, 0x0Cuy, 0xE1uy, 0x77uy, 0x05uy, 0xA0uy, 0x5Fuy, 0x85uy)
    
    ///
    /// WPD_CONTENT_TYPE_IMAGE
    ///   Indicates this object represents image data (e.g. a JPEG file)
    let WPD_CONTENT_TYPE_IMAGE = 
        new System.Guid(0xef2107d5u, 0xa52aus, 0x4243us, 0xa2uy, 0x6buy, 0x62uy, 0xd4uy, 0x17uy, 0x6duy, 0x76uy, 0x03uy)
    
    ///
    /// WPD_CONTENT_TYPE_DOCUMENT
    ///   Indicates this object represents document data (e.g. a MS WORD file, TEXT file, etc.)
    let WPD_CONTENT_TYPE_DOCUMENT = 
        new System.Guid(0x680ADF52u, 0x950Aus, 0x4041us, 0x9Buy, 0x41uy, 0x65uy, 0xE3uy, 0x93uy, 0x64uy, 0x81uy, 0x55uy)
    
    ///
    /// WPD_CONTENT_TYPE_CONTACT
    ///   Indicates this object represents contact data (e.g. name/number, or a VCARD file)
    let WPD_CONTENT_TYPE_CONTACT = 
        new System.Guid(0xEABA8313u, 0x4525us, 0x4707us, 0x9Fuy, 0x0Euy, 0x87uy, 0xC6uy, 0x80uy, 0x8Euy, 0x94uy, 0x35uy)
    
    ///
    /// WPD_CONTENT_TYPE_CONTACT_GROUP
    ///   Indicates this object represents a group of contacts.
    let WPD_CONTENT_TYPE_CONTACT_GROUP = 
        new System.Guid(0x346B8932u, 0x4C36us, 0x40D8us, 0x94uy, 0x15uy, 0x18uy, 0x28uy, 0x29uy, 0x1Fuy, 0x9Duy, 0xE9uy)
    
    ///
    /// WPD_CONTENT_TYPE_AUDIO
    ///   Indicates this object represents audio data (e.g. a WMA or MP3 file)
    let WPD_CONTENT_TYPE_AUDIO = 
        new System.Guid(0x4AD2C85Eu, 0x5E2Dus, 0x45E5us, 0x88uy, 0x64uy, 0x4Fuy, 0x22uy, 0x9Euy, 0x3Cuy, 0x6Cuy, 0xF0uy)
    
    ///
    /// WPD_CONTENT_TYPE_VIDEO
    ///   Indicates this object represents video data (e.g. a WMV or AVI file)
    let WPD_CONTENT_TYPE_VIDEO = 
        new System.Guid(0x9261B03Cu, 0x3D78us, 0x4519us, 0x85uy, 0xE3uy, 0x02uy, 0xC5uy, 0xE1uy, 0xF5uy, 0x0Buy, 0xB9uy)
    
    ///
    /// WPD_CONTENT_TYPE_TELEVISION
    ///   Indicates this object represents a television recording.
    let WPD_CONTENT_TYPE_TELEVISION = 
        new System.Guid(0x60A169CFu, 0xF2AEus, 0x4E21us, 0x93uy, 0x75uy, 0x96uy, 0x77uy, 0xF1uy, 0x1Cuy, 0x1Cuy, 0x6Euy)
    
    ///
    /// WPD_CONTENT_TYPE_PLAYLIST
    ///   Indicates this object represents a playlist.
    let WPD_CONTENT_TYPE_PLAYLIST = 
        new System.Guid(0x1A33F7E4u, 0xAF13us, 0x48F5us, 0x99uy, 0x4Euy, 0x77uy, 0x36uy, 0x9Duy, 0xFEuy, 0x04uy, 0xA3uy)
    ...
    let WPD_CONTENT_TYPE_MIXED_CONTENT_ALBUM = 
        new System.Guid(0x00F0C3ACu, 0xA593us, 0x49ACus, 0x92uy, 0x19uy, 0x24uy, 0xABuy, 0xCAuy, 0x5Auy, 0x25uy, 0x63uy)
    
    ///
    /// WPD_CONTENT_TYPE_AUDIO_ALBUM
    ///   Indicates this object represents an audio album.
    let WPD_CONTENT_TYPE_AUDIO_ALBUM = 
        new System.Guid(0xAA18737Eu, 0x5009us, 0x48FAus, 0xAEuy, 0x21uy, 0x85uy, 0xF2uy, 0x43uy, 0x83uy, 0xB4uy, 0xE6uy)
    
    ///
    /// WPD_CONTENT_TYPE_IMAGE_ALBUM
    ///   Indicates this object represents an image album.
    let WPD_CONTENT_TYPE_IMAGE_ALBUM = 
        new System.Guid(0x75793148u, 0x15F5us, 0x4A30us, 0xA8uy, 0x13uy, 0x54uy, 0xEDuy, 0x8Auy, 0x37uy, 0xE2uy, 0x26uy)
    
    ///
    /// WPD_CONTENT_TYPE_VIDEO_ALBUM
    ///   Indicates this object represents a video album.
    let WPD_CONTENT_TYPE_VIDEO_ALBUM = 
        new System.Guid(0x012B0DB7u, 0xD4C1us, 0x45D6us, 0xB0uy, 0x81uy, 0x94uy, 0xB8uy, 0x77uy, 0x79uy, 0x61uy, 0x4Fuy)
    
    ///
    /// WPD_CONTENT_TYPE_MEMO
    ///   Indicates this object represents memo data
    let WPD_CONTENT_TYPE_MEMO = 
        new System.Guid(0x9CD20ECFu, 0x3B50us, 0x414Fus, 0xA6uy, 0x41uy, 0xE4uy, 0x73uy, 0xFFuy, 0xE4uy, 0x57uy, 0x51uy)
    
    ///
    /// WPD_CONTENT_TYPE_EMAIL
    ///   Indicates this object represents e-mail data
    let WPD_CONTENT_TYPE_EMAIL = 
        new System.Guid(0x8038044Au, 0x7E51us, 0x4F8Fus, 0x88uy, 0x3Duy, 0x1Duy, 0x06uy, 0x23uy, 0xD1uy, 0x45uy, 0x33uy)
    
    ///
    /// WPD_CONTENT_TYPE_APPOINTMENT
    ///   Indicates this object represents an appointment in a calendar
    let WPD_CONTENT_TYPE_APPOINTMENT = 
        new System.Guid(0x0FED060Eu, 0x8793us, 0x4B1Eus, 0x90uy, 0xC9uy, 0x48uy, 0xACuy, 0x38uy, 0x9Auy, 0xC6uy, 0x31uy)
    
    ///
    /// WPD_CONTENT_TYPE_TASK
    ///   Indicates this object represents a task for tracking (e.g. a TODO list)
    let WPD_CONTENT_TYPE_TASK = 
        new System.Guid(0x63252F2Cu, 0x887Fus, 0x4CB6us, 0xB1uy, 0xACuy, 0xD2uy, 0x98uy, 0x55uy, 0xDCuy, 0xEFuy, 0x6Cuy)
    ...
    let WPD_CONTENT_TYPE_PROGRAM = 
        new System.Guid(0xD269F96Au, 0x247Cus, 0x4BFFus, 0x98uy, 0xFBuy, 0x97uy, 0xF3uy, 0xC4uy, 0x92uy, 0x20uy, 0xE6uy)
    ...
    let WPD_CONTENT_TYPE_GENERIC_FILE = 
        new System.Guid(0x0085E0A6u, 0x8D34us, 0x45D7us, 0xBCuy, 0x5Cuy, 0x44uy, 0x7Euy, 0x59uy, 0xC7uy, 0x3Duy, 0x48uy)
    
    ///
    /// WPD_CONTENT_TYPE_CALENDAR
    ///   Indicates this object represents a calender
    let WPD_CONTENT_TYPE_CALENDAR = 
        new System.Guid(0xA1FD5967u, 0x6023us, 0x49A0us, 0x9Duy, 0xF1uy, 0xF8uy, 0x06uy, 0x0Buy, 0xE7uy, 0x51uy, 0xB0uy)
    
    ///
    /// WPD_CONTENT_TYPE_GENERIC_MESSAGE
    ///   Indicates this object represents a message (e.g. SMS message, E-Mail message, etc.)
    let WPD_CONTENT_TYPE_GENERIC_MESSAGE = 
        new System.Guid(0xE80EAAF8u, 0xB2DBus, 0x4133us, 0xB6uy, 0x7Euy, 0x1Buy, 0xEFuy, 0x4Buy, 0x4Auy, 0x6Euy, 0x5Fuy)
    
    ///
    /// WPD_CONTENT_TYPE_NETWORK_ASSOCIATION
    ///   Indicates this object represents an association between a host and a device.
    let WPD_CONTENT_TYPE_NETWORK_ASSOCIATION = 
        new System.Guid(0x031DA7EEu, 0x18C8us, 0x4205us, 0x84uy, 0x7Euy, 0x89uy, 0xA1uy, 0x12uy, 0x61uy, 0xD0uy, 0xF3uy)
    
    ///
    /// WPD_CONTENT_TYPE_CERTIFICATE
    ///   Indicates this object represents certificate used for authentication.
    let WPD_CONTENT_TYPE_CERTIFICATE = 
        new System.Guid(0xDC3876E8u, 0xA948us, 0x4060us, 0x90uy, 0x50uy, 0xCBuy, 0xD7uy, 0x7Euy, 0x8Auy, 0x3Duy, 0x87uy)
    
    ///
    /// WPD_CONTENT_TYPE_WIRELESS_PROFILE
    ///   Indicates this object represents wireless network access information.
    let WPD_CONTENT_TYPE_WIRELESS_PROFILE = 
        new System.Guid(0x0BAC070Au, 0x9F5Fus, 0x4DA4us, 0xA8uy, 0xF6uy, 0x3Duy, 0xE4uy, 0x4Duy, 0x68uy, 0xFDuy, 0x6Cuy)
    ...
    let WPD_CONTENT_TYPE_MEDIA_CAST = 
        new System.Guid(0x5E88B3CCu, 0x3E65us, 0x4E62us, 0xBFuy, 0xFFuy, 0x22uy, 0x94uy, 0x95uy, 0x25uy, 0x3Auy, 0xB0uy)
    ...
    let WPD_CONTENT_TYPE_SECTION = 
        new System.Guid(0x821089F5u, 0x1D91us, 0x4DC9us, 0xBEuy, 0x3Cuy, 0xBBuy, 0xB1uy, 0xB3uy, 0x5Buy, 0x18uy, 0xCEuy)
    
    ///
    /// WPD_CONTENT_TYPE_UNSPECIFIED
    ///   Indicates this object doesn't fall into the predefined WPD content types
    let WPD_CONTENT_TYPE_UNSPECIFIED = 
        new System.Guid(0x28D8D31Eu, 0x249Cus, 0x454Eus, 0xAAuy, 0xBCuy, 0x34uy, 0x88uy, 0x31uy, 0x68uy, 0xE6uy, 0x34uy)
    ...
    let WPD_CONTENT_TYPE_ALL = 
        new System.Guid(0x80E170D2u, 0x1055us, 0x4A3Eus, 0xB9uy, 0x52uy, 0x82uy, 0xCCuy, 0x4Fuy, 0x8Auy, 0x86uy, 0x89uy)
    ...
    let WPD_FUNCTIONAL_CATEGORY_DEVICE = 
        new System.Guid(0x08EA466Bu, 0xE3A4us, 0x4336us, 0xA1uy, 0xF3uy, 0xA4uy, 0x4Duy, 0x2Buy, 0x5Cuy, 0x43uy, 0x8Cuy)
    ...
    let WPD_FUNCTIONAL_CATEGORY_STORAGE = 
        new System.Guid(0x23F05BBCu, 0x15DEus, 0x4C2Aus, 0xA5uy, 0x5Buy, 0xA9uy, 0xAFuy, 0x5Cuy, 0xE4uy, 0x12uy, 0xEFuy)
    ...
    let WPD_FUNCTIONAL_CATEGORY_STILL_IMAGE_CAPTURE = 
        new System.Guid(0x613CA327u, 0xAB93us, 0x4900us, 0xB4uy, 0xFAuy, 0x89uy, 0x5Buy, 0xB5uy, 0x87uy, 0x4Buy, 0x79uy)
    ...
    let WPD_FUNCTIONAL_CATEGORY_AUDIO_CAPTURE = 
        new System.Guid(0x3F2A1919u, 0xC7C2us, 0x4A00us, 0x85uy, 0x5Duy, 0xF5uy, 0x7Cuy, 0xF0uy, 0x6Duy, 0xEBuy, 0xBBuy)
    ...
    let WPD_FUNCTIONAL_CATEGORY_VIDEO_CAPTURE = 
        new System.Guid(0xE23E5F6Bu, 0x7243us, 0x43AAus, 0x8Duy, 0xF1uy, 0x0Euy, 0xB3uy, 0xD9uy, 0x68uy, 0xA9uy, 0x18uy)
    ...
    let WPD_FUNCTIONAL_CATEGORY_SMS = 
        new System.Guid(0x0044A0B1u, 0xC1E9us, 0x4AFDus, 0xB3uy, 0x58uy, 0xA6uy, 0x2Cuy, 0x61uy, 0x17uy, 0xC9uy, 0xCFuy)
    ...
    let WPD_FUNCTIONAL_CATEGORY_RENDERING_INFORMATION = 
        new System.Guid(0x08600BA4u, 0xA7BAus, 0x4A01us, 0xABuy, 0x0Euy, 0x00uy, 0x65uy, 0xD0uy, 0xA3uy, 0x56uy, 0xD3uy)
    ...
    let WPD_FUNCTIONAL_CATEGORY_NETWORK_CONFIGURATION = 
        new System.Guid(0x48F4DB72u, 0x7C6Aus, 0x4AB0us, 0x9Euy, 0x1Auy, 0x47uy, 0x0Euy, 0x3Cuy, 0xDBuy, 0xF2uy, 0x6Auy)
    ...
    let WPD_FUNCTIONAL_CATEGORY_ALL = 
        new System.Guid(0x2D8A6512u, 0xA74Cus, 0x448Eus, 0xBAuy, 0x8Auy, 0xF4uy, 0xACuy, 0x07uy, 0xC4uy, 0x93uy, 0x99uy)
    ...
    let WPD_OBJECT_FORMAT_ICON = 
        new System.Guid(0x077232EDu, 0x102Cus, 0x4638us, 0x9Cuy, 0x22uy, 0x83uy, 0xF1uy, 0x42uy, 0xBFuy, 0xC8uy, 0x22uy)
    
    ///
    /// WPD_OBJECT_FORMAT_M4A
    ///   Audio file format
    let WPD_OBJECT_FORMAT_M4A = 
        new System.Guid(0x30ABA7ACu, 0x6FFDus, 0x4C23us, 0xA3uy, 0x59uy, 0x3Euy, 0x9Buy, 0x52uy, 0xF3uy, 0xF1uy, 0xC8uy)
    
    ///
    /// WPD_OBJECT_FORMAT_NETWORK_ASSOCIATION
    ///   Network Association file format.
    let WPD_OBJECT_FORMAT_NETWORK_ASSOCIATION = 
        new System.Guid(0xB1020000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_X509V3CERTIFICATE
    ///   X.509 V3 Certificate file format.
    let WPD_OBJECT_FORMAT_X509V3CERTIFICATE = 
        new System.Guid(0xB1030000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_MICROSOFT_WFC
    ///   Windows Connect Now file format.
    let WPD_OBJECT_FORMAT_MICROSOFT_WFC = 
        new System.Guid(0xB1040000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_3GPA
    ///   Audio file format
    let WPD_OBJECT_FORMAT_3GPA = 
        new System.Guid(0xE5172730u, 0xF971us, 0x41EFus, 0xA1uy, 0x0Buy, 0x22uy, 0x71uy, 0xA0uy, 0x01uy, 0x9Duy, 0x7Auy)
    
    ///
    /// WPD_OBJECT_FORMAT_3G2A
    ///   Audio file format
    let WPD_OBJECT_FORMAT_3G2A = 
        new System.Guid(0x1A11202Du, 0x8759us, 0x4E34us, 0xBAuy, 0x5Euy, 0xB1uy, 0x21uy, 0x10uy, 0x87uy, 0xEEuy, 0xE4uy)
    ...
    let WPD_OBJECT_FORMAT_ALL = 
        new System.Guid(0xC1F62EB2u, 0x4BB3us, 0x479Cus, 0x9Cuy, 0xFAuy, 0x05uy, 0xB5uy, 0xF3uy, 0xA5uy, 0x7Buy, 0x22uy)
    ...
    ///
    let WPD_CATEGORY_NULL = 
        new System.Guid(0x00000000u, 0x0000us, 0x0000us, 0x00uy, 0x00uy, 0x00uy, 0x00uy, 0x00uy, 0x00uy, 0x00uy, 0x00uy)
    ...
    ///
    let WPD_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0xEF6B490Du, 0x5CD8us, 0x437Aus, 0xAFuy, 0xFCuy, 0xDAuy, 0x8Buy, 0x60uy, 0xEEuy, 0x4Auy, 0x3Cuy)
    ...
    let WPD_OBJECT_CONTAINER_FUNCTIONAL_OBJECT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_PROPERTIES_V1, pid = 23u)
    ...
    let WPD_OBJECT_GENERATE_THUMBNAIL_FROM_RESOURCE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_PROPERTIES_V1, pid = 24u)
    ...
    let WPD_OBJECT_HINT_LOCATION_DISPLAY_NAME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_PROPERTIES_V1, pid = 25u)
    ...
    /// This category is for all common object properties.
    ///
    let WPD_OBJECT_PROPERTIES_V2 = 
        new System.Guid(0x0373CD3Du, 0x4A46us, 0x40D7us, 0xB4uy, 0xD8uy, 0x73uy, 0xE8uy, 0xDAuy, 0x74uy, 0xE7uy, 0x75uy)
    
    ///
    /// WPD_OBJECT_SUPPORTED_UNITS  
    ///   [ VT_UI4 ] Indicates the units supported on this object.
    let WPD_OBJECT_SUPPORTED_UNITS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_PROPERTIES_V2, pid = 2u)
    ...
    ///
    let WPD_FUNCTIONAL_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0x8F052D93u, 0xABCAus, 0x4FC5us, 0xA5uy, 0xACuy, 0xB0uy, 0x1Duy, 0xF4uy, 0xDBuy, 0xE5uy, 0x98uy)
    
    ///
    /// WPD_FUNCTIONAL_OBJECT_CATEGORY  
    ///   [ VT_CLSID ] Indicates the object's functional category.
    let WPD_FUNCTIONAL_OBJECT_CATEGORY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_FUNCTIONAL_OBJECT_PROPERTIES_V1, pid = 2u)
    ...
    ///
    let WPD_STORAGE_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0x01A3057Au, 0x74D6us, 0x4E80us, 0xBEuy, 0xA7uy, 0xDCuy, 0x4Cuy, 0x21uy, 0x2Cuy, 0xE5uy, 0x0Auy)
    ...
    let WPD_STORAGE_FILE_SYSTEM_TYPE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STORAGE_OBJECT_PROPERTIES_V1, pid = 3u)
    
    ///
    /// WPD_STORAGE_CAPACITY  
    ///   [ VT_UI8 ] Indicates the total storage capacity in bytes.
    let WPD_STORAGE_CAPACITY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STORAGE_OBJECT_PROPERTIES_V1, pid = 4u)
    
    ///
    /// WPD_STORAGE_FREE_SPACE_IN_BYTES  
    ///   [ VT_UI8 ] Indicates the available space in bytes.
    let WPD_STORAGE_FREE_SPACE_IN_BYTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STORAGE_OBJECT_PROPERTIES_V1, pid = 5u)
    ...
    let WPD_STORAGE_FREE_SPACE_IN_OBJECTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STORAGE_OBJECT_PROPERTIES_V1, pid = 6u)
    
    ///
    /// WPD_STORAGE_DESCRIPTION  
    ///   [ VT_LPWSTR ] Contains a description of the storage.
    let WPD_STORAGE_DESCRIPTION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STORAGE_OBJECT_PROPERTIES_V1, pid = 7u)
    
    ///
    /// WPD_STORAGE_SERIAL_NUMBER  
    ///   [ VT_LPWSTR ] Contains the serial number of the storage.
    let WPD_STORAGE_SERIAL_NUMBER = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STORAGE_OBJECT_PROPERTIES_V1, pid = 8u)
    ...
    let WPD_STORAGE_MAX_OBJECT_SIZE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STORAGE_OBJECT_PROPERTIES_V1, pid = 9u)
    ...
    let WPD_STORAGE_CAPACITY_IN_OBJECTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STORAGE_OBJECT_PROPERTIES_V1, pid = 10u)
    ...
    let WPD_STORAGE_ACCESS_CAPABILITY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STORAGE_OBJECT_PROPERTIES_V1, pid = 11u)
    ...
    ///
    let WPD_NETWORK_ASSOCIATION_PROPERTIES_V1 = 
        new System.Guid(0xE4C93C1Fu, 0xB203us, 0x43F1us, 0xA1uy, 0x00uy, 0x5Auy, 0x07uy, 0xD1uy, 0x1Buy, 0x02uy, 0x74uy)
    ...
    let WPD_NETWORK_ASSOCIATION_HOST_NETWORK_IDENTIFIERS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_NETWORK_ASSOCIATION_PROPERTIES_V1, pid = 2u)
    ...
    let WPD_NETWORK_ASSOCIATION_X509V3SEQUENCE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_NETWORK_ASSOCIATION_PROPERTIES_V1, pid = 3u)
    ...
    ///
    let WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0x58C571ECu, 0x1BCBus, 0x42A7us, 0x8Auy, 0xC5uy, 0xBBuy, 0x29uy, 0x15uy, 0x73uy, 0xA2uy, 0x60uy)
    ...
    let WPD_STILL_IMAGE_CAPTURE_RESOLUTION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 2u)
    
    ///
    /// WPD_STILL_IMAGE_CAPTURE_FORMAT  
    ///   [ VT_CLSID ] Controls the format of the image to capture.
    let WPD_STILL_IMAGE_CAPTURE_FORMAT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 3u)
    ...
    let WPD_STILL_IMAGE_COMPRESSION_SETTING = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 4u)
    
    ///
    /// WPD_STILL_IMAGE_WHITE_BALANCE  
    ///   [ VT_UI4 ] Controls how the device weights color channels.
    let WPD_STILL_IMAGE_WHITE_BALANCE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 5u)
    
    ///
    /// WPD_STILL_IMAGE_RGB_GAIN  
    ///   [ VT_LPWSTR ] Controls the RGB gain.
    let WPD_STILL_IMAGE_RGB_GAIN = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 6u)
    
    ///
    /// WPD_STILL_IMAGE_FNUMBER  
    ///   [ VT_UI4 ] Controls the aperture of the lens.
    let WPD_STILL_IMAGE_FNUMBER = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 7u)
    
    ///
    /// WPD_STILL_IMAGE_FOCAL_LENGTH  
    ///   [ VT_UI4 ] Controls the 35mm equivalent focal length.
    let WPD_STILL_IMAGE_FOCAL_LENGTH = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 8u)
    ...
    let WPD_STILL_IMAGE_FOCUS_DISTANCE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 9u)
    ...
    let WPD_STILL_IMAGE_FOCUS_MODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 10u)
    ...
    let WPD_STILL_IMAGE_EXPOSURE_METERING_MODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 11u)
    
    ///
    /// WPD_STILL_IMAGE_FLASH_MODE  
    ///   [ VT_UI4 ]
    let WPD_STILL_IMAGE_FLASH_MODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 12u)
    
    ///
    /// WPD_STILL_IMAGE_EXPOSURE_TIME  
    ///   [ VT_UI4 ] Controls the shutter speed of the device.
    let WPD_STILL_IMAGE_EXPOSURE_TIME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 13u)
    ...
    let WPD_STILL_IMAGE_EXPOSURE_PROGRAM_MODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 14u)
    
    ///
    /// WPD_STILL_IMAGE_EXPOSURE_INDEX  
    ///   [ VT_UI4 ] Controls the emulation of film speed settings.
    let WPD_STILL_IMAGE_EXPOSURE_INDEX = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 15u)
    ...
    let WPD_STILL_IMAGE_EXPOSURE_BIAS_COMPENSATION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 16u)
    ...
    let WPD_STILL_IMAGE_CAPTURE_DELAY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 17u)
    
    ///
    /// WPD_STILL_IMAGE_CAPTURE_MODE  
    ///   [ VT_UI4 ] Controls the type of still image capture.
    let WPD_STILL_IMAGE_CAPTURE_MODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 18u)
    
    ///
    /// WPD_STILL_IMAGE_CONTRAST  
    ///   [ VT_UI4 ] Controls the perceived contrast of captured images.
    let WPD_STILL_IMAGE_CONTRAST = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 19u)
    
    ///
    /// WPD_STILL_IMAGE_SHARPNESS  
    ///   [ VT_UI4 ] Controls the perceived sharpness of the captured image.
    let WPD_STILL_IMAGE_SHARPNESS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 20u)
    ...
    let WPD_STILL_IMAGE_DIGITAL_ZOOM = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 21u)
    
    ///
    /// WPD_STILL_IMAGE_EFFECT_MODE  
    ///   [ VT_UI4 ] Controls the special effect mode of the capture.
    let WPD_STILL_IMAGE_EFFECT_MODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 22u)
    ...
    let WPD_STILL_IMAGE_BURST_NUMBER = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 23u)
    ...
    let WPD_STILL_IMAGE_BURST_INTERVAL = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 24u)
    ...
    let WPD_STILL_IMAGE_TIMELAPSE_NUMBER = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 25u)
    ...
    let WPD_STILL_IMAGE_TIMELAPSE_INTERVAL = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 26u)
    ...
    let WPD_STILL_IMAGE_FOCUS_METERING_MODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 27u)
    ...
    let WPD_STILL_IMAGE_UPLOAD_URL = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 28u)
    ...
    let WPD_STILL_IMAGE_ARTIST = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 29u)
    
    ///
    /// WPD_STILL_IMAGE_CAMERA_MODEL  
    ///   [ VT_LPWSTR ] Contains the model of the device
    let WPD_STILL_IMAGE_CAMERA_MODEL = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 30u)
    ...
    let WPD_STILL_IMAGE_CAMERA_MANUFACTURER = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1, pid = 31u)
    ...
    ///
    let WPD_RENDERING_INFORMATION_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0xC53D039Fu, 0xEE23us, 0x4A31us, 0x85uy, 0x90uy, 0x76uy, 0x39uy, 0x87uy, 0x98uy, 0x70uy, 0xB4uy)
    ...
    let WPD_RENDERING_INFORMATION_PROFILES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RENDERING_INFORMATION_OBJECT_PROPERTIES_V1, pid = 2u)
    ...
    let WPD_RENDERING_INFORMATION_PROFILE_ENTRY_TYPE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RENDERING_INFORMATION_OBJECT_PROPERTIES_V1, pid = 3u)
    ...
    let WPD_RENDERING_INFORMATION_PROFILE_ENTRY_CREATABLE_RESOURCES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RENDERING_INFORMATION_OBJECT_PROPERTIES_V1, pid = 4u)
    ...
    /// 
    ///
    let WPD_CLIENT_INFORMATION_PROPERTIES_V1 = 
        new System.Guid(0x204D9F0Cu, 0x2292us, 0x4080us, 0x9Fuy, 0x42uy, 0x40uy, 0x66uy, 0x4Euy, 0x70uy, 0xF8uy, 0x59uy)
    
    ///
    /// WPD_CLIENT_NAME  
    ///   [ VT_LPWSTR ] Specifies the name the client uses to identify itself.
    let WPD_CLIENT_NAME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLIENT_INFORMATION_PROPERTIES_V1, pid = 2u)
    
    ///
    /// WPD_CLIENT_MAJOR_VERSION  
    ///   [ VT_UI4 ] Specifies the major version of the client.
    let WPD_CLIENT_MAJOR_VERSION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLIENT_INFORMATION_PROPERTIES_V1, pid = 3u)
    
    ///
    /// WPD_CLIENT_MINOR_VERSION  
    ///   [ VT_UI4 ] Specifies the major version of the client.
    let WPD_CLIENT_MINOR_VERSION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLIENT_INFORMATION_PROPERTIES_V1, pid = 4u)
    
    ///
    /// WPD_CLIENT_REVISION  
    ///   [ VT_UI4 ] Specifies the revision (or build number) of the client.
    let WPD_CLIENT_REVISION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLIENT_INFORMATION_PROPERTIES_V1, pid = 5u)
    ...
    let WPD_CLIENT_WMDRM_APPLICATION_PRIVATE_KEY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLIENT_INFORMATION_PROPERTIES_V1, pid = 6u)
    ...
    let WPD_CLIENT_WMDRM_APPLICATION_CERTIFICATE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLIENT_INFORMATION_PROPERTIES_V1, pid = 7u)
    ...
    let WPD_CLIENT_SECURITY_QUALITY_OF_SERVICE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLIENT_INFORMATION_PROPERTIES_V1, pid = 8u)
    ...
    let WPD_CLIENT_DESIRED_ACCESS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLIENT_INFORMATION_PROPERTIES_V1, pid = 9u)
    ...
    let WPD_CLIENT_SHARE_MODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLIENT_INFORMATION_PROPERTIES_V1, pid = 10u)
    ...
    let WPD_CLIENT_EVENT_COOKIE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLIENT_INFORMATION_PROPERTIES_V1, pid = 11u)
    ...
    let WPD_CLIENT_MINIMUM_RESULTS_BUFFER_SIZE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLIENT_INFORMATION_PROPERTIES_V1, pid = 12u)
    ...
    let WPD_CLIENT_MANUAL_CLOSE_ON_DISCONNECT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLIENT_INFORMATION_PROPERTIES_V1, pid = 13u)
    ...
    /// 
    ///
    let WPD_PROPERTY_ATTRIBUTES_V1 = 
        new System.Guid(0xAB7943D8u, 0x6332us, 0x445Fus, 0xA0uy, 0x0Duy, 0x8Duy, 0x5Euy, 0xF1uy, 0xE9uy, 0x6Fuy, 0x37uy)
    ...
    let WPD_PROPERTY_ATTRIBUTE_FORM = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V1, pid = 2u)
    ...
    let WPD_PROPERTY_ATTRIBUTE_CAN_READ = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V1, pid = 3u)
    ...
    let WPD_PROPERTY_ATTRIBUTE_CAN_WRITE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V1, pid = 4u)
    ...
    let WPD_PROPERTY_ATTRIBUTE_CAN_DELETE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V1, pid = 5u)
    ...
    let WPD_PROPERTY_ATTRIBUTE_DEFAULT_VALUE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V1, pid = 6u)
    ...
    let WPD_PROPERTY_ATTRIBUTE_FAST_PROPERTY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V1, pid = 7u)
    ...
    let WPD_PROPERTY_ATTRIBUTE_RANGE_MIN = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V1, pid = 8u)
    ...
    let WPD_PROPERTY_ATTRIBUTE_RANGE_MAX = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V1, pid = 9u)
    ...
    let WPD_PROPERTY_ATTRIBUTE_RANGE_STEP = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V1, pid = 10u)
    ...
    let WPD_PROPERTY_ATTRIBUTE_ENUMERATION_ELEMENTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V1, pid = 11u)
    ...
    let WPD_PROPERTY_ATTRIBUTE_REGULAR_EXPRESSION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V1, pid = 12u)
    ...
    let WPD_PROPERTY_ATTRIBUTE_MAX_SIZE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V1, pid = 13u)
    ...
    ///
    let WPD_PROPERTY_ATTRIBUTES_V2 = 
        new System.Guid(0x5D9DA160u, 0x74AEus, 0x43CCus, 0x85uy, 0xA9uy, 0xFEuy, 0x55uy, 0x5Auy, 0x80uy, 0x79uy, 0x8Euy)
    
    ///
    /// WPD_PROPERTY_ATTRIBUTE_NAME  
    ///   [ VT_LPWSTR ] Contains the name of the property.
    let WPD_PROPERTY_ATTRIBUTE_NAME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V2, pid = 2u)
    
    ///
    /// WPD_PROPERTY_ATTRIBUTE_VARTYPE  
    ///   [ VT_UI4 ] Contains the VARTYPE of the property.
    let WPD_PROPERTY_ATTRIBUTE_VARTYPE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PROPERTY_ATTRIBUTES_V2, pid = 3u)
    ...
    ///
    let WPD_CLASS_EXTENSION_OPTIONS_V1 = 
        new System.Guid(0x6309FFEFu, 0xA87Cus, 0x4CA7us, 0x84uy, 0x34uy, 0x79uy, 0x75uy, 0x76uy, 0xE4uy, 0x0Auy, 0x96uy)
    ...
    let WPD_CLASS_EXTENSION_OPTIONS_SUPPORTED_CONTENT_TYPES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_OPTIONS_V1, pid = 2u)
    ...
    let WPD_CLASS_EXTENSION_OPTIONS_DONT_REGISTER_WPD_DEVICE_INTERFACE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_OPTIONS_V1, pid = 3u)
    ...
    let WPD_CLASS_EXTENSION_OPTIONS_REGISTER_WPD_PRIVATE_DEVICE_INTERFACE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_OPTIONS_V1, pid = 4u)
    ...
    /// This category of properties relates to options used for the WPD device class extension
    ///
    let WPD_CLASS_EXTENSION_OPTIONS_V2 = 
        new System.Guid(0x3E3595DAu, 0x4D71us, 0x49FEus, 0xA0uy, 0xB4uy, 0xD4uy, 0x40uy, 0x6Cuy, 0x3Auy, 0xE9uy, 0x3Fuy)
    ...
    let WPD_CLASS_EXTENSION_OPTIONS_MULTITRANSPORT_MODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_OPTIONS_V2, pid = 2u)
    ...
    let WPD_CLASS_EXTENSION_OPTIONS_DEVICE_IDENTIFICATION_VALUES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_OPTIONS_V2, pid = 3u)
    ...
    let WPD_CLASS_EXTENSION_OPTIONS_TRANSPORT_BANDWIDTH = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_OPTIONS_V2, pid = 4u)
    ...
    /// This category of properties relates to options used for the WPD device class extension
    ///
    let WPD_CLASS_EXTENSION_OPTIONS_V3 = 
        new System.Guid(0x65C160F8u, 0x1367us, 0x4CE2us, 0x93uy, 0x9Duy, 0x83uy, 0x10uy, 0x83uy, 0x9Fuy, 0x0Duy, 0x30uy)
    ...
    let WPD_CLASS_EXTENSION_OPTIONS_SILENCE_AUTOPLAY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_OPTIONS_V3, pid = 2u)
    ...
    /// 
    ///
    let WPD_RESOURCE_ATTRIBUTES_V1 = 
        new System.Guid(0x1EB6F604u, 0x9278us, 0x429Fus, 0x93uy, 0xCCuy, 0x5Buy, 0xB8uy, 0xC0uy, 0x66uy, 0x56uy, 0xB6uy)
    
    ///
    /// WPD_RESOURCE_ATTRIBUTE_TOTAL_SIZE  
    ///   [ VT_UI8 ] Total size in bytes of the resource data.
    let WPD_RESOURCE_ATTRIBUTE_TOTAL_SIZE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RESOURCE_ATTRIBUTES_V1, pid = 2u)
    ...
    let WPD_RESOURCE_ATTRIBUTE_CAN_READ = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RESOURCE_ATTRIBUTES_V1, pid = 3u)
    ...
    let WPD_RESOURCE_ATTRIBUTE_CAN_WRITE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RESOURCE_ATTRIBUTES_V1, pid = 4u)
    ...
    let WPD_RESOURCE_ATTRIBUTE_CAN_DELETE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RESOURCE_ATTRIBUTES_V1, pid = 5u)
    ...
    let WPD_RESOURCE_ATTRIBUTE_OPTIMAL_READ_BUFFER_SIZE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RESOURCE_ATTRIBUTES_V1, pid = 6u)
    ...
    let WPD_RESOURCE_ATTRIBUTE_OPTIMAL_WRITE_BUFFER_SIZE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RESOURCE_ATTRIBUTES_V1, pid = 7u)
    
    ///
    /// WPD_RESOURCE_ATTRIBUTE_FORMAT  
    ///   [ VT_CLSID ] Indicates the format of the resource data.
    let WPD_RESOURCE_ATTRIBUTE_FORMAT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RESOURCE_ATTRIBUTES_V1, pid = 8u)
    ...
    let WPD_RESOURCE_ATTRIBUTE_RESOURCE_KEY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RESOURCE_ATTRIBUTES_V1, pid = 9u)
    ...
    /// 
    ///
    let WPD_DEVICE_PROPERTIES_V1 = 
        new System.Guid(0x26D4979Au, 0xE643us, 0x4626us, 0x9Euy, 0x2Buy, 0x73uy, 0x6Duy, 0xC0uy, 0xC9uy, 0x2Fuy, 0xDCuy)
    ...
    let WPD_DEVICE_FIRMWARE_VERSION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_DEVICE_PROPERTIES_V1, pid = 3u)
    ...
    let WPD_DEVICE_SUPPORTS_NON_CONSUMABLE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_DEVICE_PROPERTIES_V1, pid = 10u)
    ...
    let WPD_DEVICE_SUPPORTED_DRM_SCHEMES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_DEVICE_PROPERTIES_V1, pid = 13u)
    ...
    let WPD_DEVICE_SUPPORTED_FORMATS_ARE_ORDERED = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_DEVICE_PROPERTIES_V1, pid = 14u)
    ...
    let WPD_DEVICE_NETWORK_IDENTIFIER = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_DEVICE_PROPERTIES_V1, pid = 16u)
    ...
    /// 
    ///
    let WPD_DEVICE_PROPERTIES_V2 = 
        new System.Guid(0x463DD662u, 0x7FC4us, 0x4291us, 0x91uy, 0x1Cuy, 0x7Fuy, 0x4Cuy, 0x9Cuy, 0xCAuy, 0x97uy, 0x99uy)
    ...
    let WPD_DEVICE_FUNCTIONAL_UNIQUE_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_DEVICE_PROPERTIES_V2, pid = 2u)
    ...
    let WPD_DEVICE_MODEL_UNIQUE_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_DEVICE_PROPERTIES_V2, pid = 3u)
    ...
    let WPD_DEVICE_USE_DEVICE_STAGE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_DEVICE_PROPERTIES_V2, pid = 5u)
    ...
    /// 
    ///
    let WPD_SERVICE_PROPERTIES_V1 = 
        new System.Guid(0x7510698Au, 0xCB54us, 0x481Cus, 0xB8uy, 0xDBuy, 0x0Duy, 0x75uy, 0xC9uy, 0x3Fuy, 0x1Cuy, 0x06uy)
    ...
    ///
    let WPD_EVENT_PROPERTIES_V1 = 
        new System.Guid(0x15AB1953u, 0xF817us, 0x4FEFus, 0xA9uy, 0x21uy, 0x56uy, 0x76uy, 0xE8uy, 0x38uy, 0xF6uy, 0xE0uy)
    ...
    let WPD_EVENT_PARAMETER_PNP_DEVICE_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EVENT_PROPERTIES_V1, pid = 2u)
    
    ///
    /// WPD_EVENT_PARAMETER_EVENT_ID  
    ///   [ VT_CLSID ] Indicates the event sent.
    let WPD_EVENT_PARAMETER_EVENT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EVENT_PROPERTIES_V1, pid = 3u)
    ...
    let WPD_EVENT_PARAMETER_OPERATION_STATE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EVENT_PROPERTIES_V1, pid = 4u)
    ...
    let WPD_EVENT_PARAMETER_OPERATION_PROGRESS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EVENT_PROPERTIES_V1, pid = 5u)
    ...
    let WPD_EVENT_PARAMETER_OBJECT_PARENT_PERSISTENT_UNIQUE_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EVENT_PROPERTIES_V1, pid = 6u)
    ...
    let WPD_EVENT_PARAMETER_OBJECT_CREATION_COOKIE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EVENT_PROPERTIES_V1, pid = 7u)
    ...
    let WPD_EVENT_PARAMETER_CHILD_HIERARCHY_CHANGED = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EVENT_PROPERTIES_V1, pid = 8u)
    ...
    /// The properties in this category are for properties that may be needed for event processing, but do not have object property equivalents (i.e. they are not exposed as object properties, but rather, used only as event parameters).
    ///
    let WPD_EVENT_PROPERTIES_V2 = 
        new System.Guid(0x52807B8Au, 0x4914us, 0x4323us, 0x9Buy, 0x9Auy, 0x74uy, 0xF6uy, 0x54uy, 0xB2uy, 0xB8uy, 0x46uy)
    ...
    let WPD_EVENT_PARAMETER_SERVICE_METHOD_CONTEXT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EVENT_PROPERTIES_V2, pid = 2u)
    ...
    ///
    let WPD_EVENT_OPTIONS_V1 = 
        new System.Guid(0xB3D8DAD7u, 0xA361us, 0x4B83us, 0x8Auy, 0x48uy, 0x5Buy, 0x02uy, 0xCEuy, 0x10uy, 0x71uy, 0x3Buy)
    ...
    let WPD_EVENT_OPTION_IS_BROADCAST_EVENT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EVENT_OPTIONS_V1, pid = 2u)
    ...
    let WPD_EVENT_OPTION_IS_AUTOPLAY_EVENT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EVENT_OPTIONS_V1, pid = 3u)
    ...
    ///
    let WPD_EVENT_ATTRIBUTES_V1 = 
        new System.Guid(0x10C96578u, 0x2E81us, 0x4111us, 0xADuy, 0xDEuy, 0xE0uy, 0x8Cuy, 0xA6uy, 0x13uy, 0x8Fuy, 0x6Duy)
    ...
    let WPD_EVENT_ATTRIBUTE_PARAMETERS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EVENT_ATTRIBUTES_V1, pid = 3u)
    
    ///
    /// WPD_EVENT_ATTRIBUTE_OPTIONS  
    ///   [ VT_UNKNOWN ] IPortableDeviceValues containing the event options.
    let WPD_EVENT_ATTRIBUTE_OPTIONS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EVENT_ATTRIBUTES_V1, pid = 4u)
    ...
    ///
    let WPD_API_OPTIONS_V1 = 
        new System.Guid(0x10E54A3Eu, 0x052Dus, 0x4777us, 0xA1uy, 0x3Cuy, 0xDEuy, 0x76uy, 0x14uy, 0xBEuy, 0x2Buy, 0xC4uy)
    ...
    let WPD_API_OPTION_USE_CLEAR_DATA_STREAM = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_API_OPTIONS_V1, pid = 2u)
    ...
    ///
    let WPD_FORMAT_ATTRIBUTES_V1 = 
        new System.Guid(0xA0A02000u, 0xBCAFus, 0x4BE8us, 0xB3uy, 0xF5uy, 0x23uy, 0x3Fuy, 0x23uy, 0x1Cuy, 0xF5uy, 0x8Fuy)
    ...
    let WPD_FORMAT_ATTRIBUTE_MIMETYPE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_FORMAT_ATTRIBUTES_V1, pid = 3u)
    ...
    ///
    let WPD_METHOD_ATTRIBUTES_V1 = 
        new System.Guid(0xF17A5071u, 0xF039us, 0x44AFus, 0x8Euy, 0xFEuy, 0x43uy, 0x2Cuy, 0xF3uy, 0x2Euy, 0x43uy, 0x2Auy)
    ...
    let WPD_METHOD_ATTRIBUTE_ASSOCIATED_FORMAT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_METHOD_ATTRIBUTES_V1, pid = 3u)
    
    ///
    /// WPD_METHOD_ATTRIBUTE_ACCESS  
    ///   [ VT_UI4 ] Indicates the required access for a method.
    let WPD_METHOD_ATTRIBUTE_ACCESS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_METHOD_ATTRIBUTES_V1, pid = 4u)
    ...
    let WPD_METHOD_ATTRIBUTE_PARAMETERS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_METHOD_ATTRIBUTES_V1, pid = 5u)
    ...
    ///
    let WPD_PARAMETER_ATTRIBUTES_V1 = 
        new System.Guid(0xE6864DD7u, 0xF325us, 0x45EAus, 0xA1uy, 0xD5uy, 0x97uy, 0xCFuy, 0x73uy, 0xB6uy, 0xCAuy, 0x58uy)
    
    ///
    /// WPD_PARAMETER_ATTRIBUTE_ORDER  
    ///   [ VT_UI4 ] The order (starting from 0) of a method parameter.
    let WPD_PARAMETER_ATTRIBUTE_ORDER = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PARAMETER_ATTRIBUTES_V1, pid = 2u)
    
    ///
    /// WPD_PARAMETER_ATTRIBUTE_USAGE  
    ///   [ VT_UI4 ] The usage of the method parameter.
    let WPD_PARAMETER_ATTRIBUTE_USAGE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PARAMETER_ATTRIBUTES_V1, pid = 3u)
    ...
    let WPD_PARAMETER_ATTRIBUTE_FORM = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PARAMETER_ATTRIBUTES_V1, pid = 4u)
    ...
    let WPD_PARAMETER_ATTRIBUTE_DEFAULT_VALUE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PARAMETER_ATTRIBUTES_V1, pid = 5u)
    ...
    let WPD_PARAMETER_ATTRIBUTE_RANGE_MIN = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PARAMETER_ATTRIBUTES_V1, pid = 6u)
    ...
    let WPD_PARAMETER_ATTRIBUTE_RANGE_MAX = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PARAMETER_ATTRIBUTES_V1, pid = 7u)
    ...
    let WPD_PARAMETER_ATTRIBUTE_RANGE_STEP = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PARAMETER_ATTRIBUTES_V1, pid = 8u)
    
    ///
    /// WPD_PARAMETER_ATTRIBUTE_ENUMERATION_ELEMENTS  
    ///   [ VT_UNKNOWN ] An IPortableDevicePropVariantCollection containing the enumeration values.
    let WPD_PARAMETER_ATTRIBUTE_ENUMERATION_ELEMENTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PARAMETER_ATTRIBUTES_V1, pid = 9u)
    ...
    let WPD_PARAMETER_ATTRIBUTE_REGULAR_EXPRESSION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PARAMETER_ATTRIBUTES_V1, pid = 10u)
    ...
    let WPD_PARAMETER_ATTRIBUTE_MAX_SIZE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PARAMETER_ATTRIBUTES_V1, pid = 11u)
    
    ///
    /// WPD_PARAMETER_ATTRIBUTE_VARTYPE  
    ///   [ VT_UI4 ] Contains the VARTYPE of the parameter.
    let WPD_PARAMETER_ATTRIBUTE_VARTYPE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PARAMETER_ATTRIBUTES_V1, pid = 12u)
    
    ///
    /// WPD_PARAMETER_ATTRIBUTE_NAME  
    ///   [ VT_LPWSTR ] Contains the parameter name.
    let WPD_PARAMETER_ATTRIBUTE_NAME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_PARAMETER_ATTRIBUTES_V1, pid = 13u)
    ...
    /// 
    ///
    let WPD_CATEGORY_COMMON = 
        new System.Guid(0xF0422A9Cu, 0x5DC8us, 0x4440us, 0xB5uy, 0xBDuy, 0x5Duy, 0xF2uy, 0x88uy, 0x35uy, 0x65uy, 0x8Auy)
    ...
    let WPD_COMMAND_COMMON_RESET_DEVICE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_COMMON, pid = 2u)
    ...
    let WPD_COMMAND_COMMON_GET_OBJECT_IDS_FROM_PERSISTENT_UNIQUE_IDS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_COMMON, pid = 3u)
    ...
    let WPD_COMMAND_COMMON_SAVE_CLIENT_INFORMATION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_COMMON, pid = 4u)
    ...
    let WPD_PROPERTY_COMMON_COMMAND_CATEGORY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_COMMON, pid = 1001u)
    ...
    let WPD_PROPERTY_COMMON_COMMAND_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_COMMON, pid = 1002u)
    ...
    let WPD_PROPERTY_COMMON_DRIVER_ERROR_CODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_COMMON, pid = 1004u)
    ...
    let WPD_PROPERTY_COMMON_COMMAND_TARGET = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_COMMON, pid = 1006u)
    ...
    let WPD_PROPERTY_COMMON_PERSISTENT_UNIQUE_IDS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_COMMON, pid = 1007u)
    ...
    let WPD_PROPERTY_COMMON_OBJECT_IDS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_COMMON, pid = 1008u)
    ...
    let WPD_PROPERTY_COMMON_CLIENT_INFORMATION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_COMMON, pid = 1009u)
    ...
    let WPD_PROPERTY_COMMON_CLIENT_INFORMATION_CONTEXT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_COMMON, pid = 1010u)
    ...
    let WPD_PROPERTY_COMMON_ACTIVITY_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_COMMON, pid = 1011u)
    ...
    ///
    let WPD_CATEGORY_OBJECT_ENUMERATION = 
        new System.Guid(0xB7474E91u, 0xE7F8us, 0x4AD9us, 0xB4uy, 0x00uy, 0xADuy, 0x1Auy, 0x4Buy, 0x58uy, 0xEEuy, 0xECuy)
    ...
    let WPD_COMMAND_OBJECT_ENUMERATION_START_FIND = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_ENUMERATION, pid = 2u)
    ...
    let WPD_COMMAND_OBJECT_ENUMERATION_FIND_NEXT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_ENUMERATION, pid = 3u)
    ...
    let WPD_COMMAND_OBJECT_ENUMERATION_END_FIND = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_ENUMERATION, pid = 4u)
    ...
    let WPD_PROPERTY_OBJECT_ENUMERATION_PARENT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_ENUMERATION, pid = 1001u)
    ...
    let WPD_PROPERTY_OBJECT_ENUMERATION_FILTER = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_ENUMERATION, pid = 1002u)
    ...
    let WPD_PROPERTY_OBJECT_ENUMERATION_OBJECT_IDS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_ENUMERATION, pid = 1003u)
    ...
    let WPD_PROPERTY_OBJECT_ENUMERATION_CONTEXT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_ENUMERATION, pid = 1004u)
    ...
    let WPD_PROPERTY_OBJECT_ENUMERATION_NUM_OBJECTS_REQUESTED = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_ENUMERATION, pid = 1005u)
    ...
    ///
    let WPD_CATEGORY_OBJECT_PROPERTIES = 
        new System.Guid(0x9E5582E4u, 0x0814us, 0x44E6us, 0x98uy, 0x1Auy, 0xB2uy, 0x99uy, 0x8Duy, 0x58uy, 0x38uy, 0x04uy)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_GET_SUPPORTED = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES, pid = 2u)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_GET_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES, pid = 3u)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_GET = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES, pid = 4u)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_SET = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES, pid = 5u)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_GET_ALL = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES, pid = 6u)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_DELETE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES, pid = 7u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_OBJECT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES, pid = 1001u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_PROPERTY_KEYS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES, pid = 1002u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_PROPERTY_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES, pid = 1003u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_PROPERTY_VALUES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES, pid = 1004u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_PROPERTY_WRITE_RESULTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES, pid = 1005u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_PROPERTY_DELETE_RESULTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES, pid = 1006u)
    ...
    ///
    let WPD_CATEGORY_OBJECT_PROPERTIES_BULK = 
        new System.Guid(0x11C824DDu, 0x04CDus, 0x4E4Eus, 0x8Cuy, 0x7Buy, 0xF6uy, 0xEFuy, 0xB7uy, 0x94uy, 0xD8uy, 0x4Euy)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_BULK_GET_VALUES_BY_OBJECT_LIST_START = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 2u)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_BULK_GET_VALUES_BY_OBJECT_LIST_NEXT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 3u)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_BULK_GET_VALUES_BY_OBJECT_LIST_END = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 4u)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_BULK_GET_VALUES_BY_OBJECT_FORMAT_START = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 5u)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_BULK_GET_VALUES_BY_OBJECT_FORMAT_NEXT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 6u)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_BULK_GET_VALUES_BY_OBJECT_FORMAT_END = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 7u)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_BULK_SET_VALUES_BY_OBJECT_LIST_START = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 8u)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_BULK_SET_VALUES_BY_OBJECT_LIST_NEXT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 9u)
    ...
    let WPD_COMMAND_OBJECT_PROPERTIES_BULK_SET_VALUES_BY_OBJECT_LIST_END = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 10u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_BULK_OBJECT_IDS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 1001u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_BULK_CONTEXT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 1002u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_BULK_VALUES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 1003u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_BULK_PROPERTY_KEYS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 1004u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_BULK_DEPTH = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 1005u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_BULK_PARENT_OBJECT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 1006u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_BULK_OBJECT_FORMAT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 1007u)
    ...
    let WPD_PROPERTY_OBJECT_PROPERTIES_BULK_WRITE_RESULTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_PROPERTIES_BULK, pid = 1008u)
    ...
    ///
    let WPD_CATEGORY_OBJECT_RESOURCES = 
        new System.Guid(0xB3A2B22Du, 0xA595us, 0x4108us, 0xBEuy, 0x0Auy, 0xFCuy, 0x3Cuy, 0x96uy, 0x5Fuy, 0x3Duy, 0x4Auy)
    ...
    let WPD_COMMAND_OBJECT_RESOURCES_GET_SUPPORTED = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 2u)
    ...
    let WPD_COMMAND_OBJECT_RESOURCES_GET_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 3u)
    ...
    let WPD_COMMAND_OBJECT_RESOURCES_OPEN = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 4u)
    ...
    let WPD_COMMAND_OBJECT_RESOURCES_READ = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 5u)
    ...
    let WPD_COMMAND_OBJECT_RESOURCES_WRITE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 6u)
    ...
    let WPD_COMMAND_OBJECT_RESOURCES_CLOSE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 7u)
    ...
    let WPD_COMMAND_OBJECT_RESOURCES_DELETE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 8u)
    ...
    let WPD_COMMAND_OBJECT_RESOURCES_CREATE_RESOURCE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 9u)
    ...
    let WPD_COMMAND_OBJECT_RESOURCES_REVERT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 10u)
    ...
    let WPD_COMMAND_OBJECT_RESOURCES_SEEK = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 11u)
    ...
    let WPD_COMMAND_OBJECT_RESOURCES_COMMIT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 12u)
    ...
    let WPD_COMMAND_OBJECT_RESOURCES_SEEK_IN_UNITS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 13u)
    
    ///
    /// WPD_PROPERTY_OBJECT_RESOURCES_OBJECT_ID  
    ///   [ VT_LPWSTR ]
    let WPD_PROPERTY_OBJECT_RESOURCES_OBJECT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1001u)
    ...
    let WPD_PROPERTY_OBJECT_RESOURCES_ACCESS_MODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1002u)
    
    ///
    /// WPD_PROPERTY_OBJECT_RESOURCES_RESOURCE_KEYS  
    ///   [ VT_UNKNOWN ]
    let WPD_PROPERTY_OBJECT_RESOURCES_RESOURCE_KEYS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1003u)
    ...
    let WPD_PROPERTY_OBJECT_RESOURCES_RESOURCE_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1004u)
    ...
    let WPD_PROPERTY_OBJECT_RESOURCES_CONTEXT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1005u)
    ...
    let WPD_PROPERTY_OBJECT_RESOURCES_NUM_BYTES_TO_READ = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1006u)
    ...
    let WPD_PROPERTY_OBJECT_RESOURCES_NUM_BYTES_READ = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1007u)
    ...
    let WPD_PROPERTY_OBJECT_RESOURCES_NUM_BYTES_TO_WRITE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1008u)
    ...
    let WPD_PROPERTY_OBJECT_RESOURCES_NUM_BYTES_WRITTEN = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1009u)
    
    ///
    /// WPD_PROPERTY_OBJECT_RESOURCES_DATA  
    ///   [ VT_VECTOR | VT_UI1 ]
    let WPD_PROPERTY_OBJECT_RESOURCES_DATA = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1010u)
    ...
    let WPD_PROPERTY_OBJECT_RESOURCES_OPTIMAL_TRANSFER_BUFFER_SIZE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1011u)
    ...
    let WPD_PROPERTY_OBJECT_RESOURCES_SEEK_OFFSET = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1012u)
    ...
    let WPD_PROPERTY_OBJECT_RESOURCES_SEEK_ORIGIN_FLAG = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1013u)
    ...
    let WPD_PROPERTY_OBJECT_RESOURCES_POSITION_FROM_START = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1014u)
    ...
    let WPD_PROPERTY_OBJECT_RESOURCES_SUPPORTS_UNITS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1015u)
    ...
    let WPD_PROPERTY_OBJECT_RESOURCES_STREAM_UNITS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 1016u)
    ...
    let WPD_OPTION_OBJECT_RESOURCES_SEEK_ON_READ_SUPPORTED = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 5001u)
    ...
    let WPD_OPTION_OBJECT_RESOURCES_SEEK_ON_WRITE_SUPPORTED = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 5002u)
    ...
    let WPD_OPTION_OBJECT_RESOURCES_NO_INPUT_BUFFER_ON_READ = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_RESOURCES, pid = 5003u)
    ...
    ///
    let WPD_CATEGORY_OBJECT_MANAGEMENT = 
        new System.Guid(0xEF1E43DDu, 0xA9EDus, 0x4341us, 0x8Buy, 0xCCuy, 0x18uy, 0x61uy, 0x92uy, 0xAEuy, 0xA0uy, 0x89uy)
    ...
    let WPD_COMMAND_OBJECT_MANAGEMENT_CREATE_OBJECT_WITH_PROPERTIES_ONLY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 2u)
    ...
    let WPD_COMMAND_OBJECT_MANAGEMENT_CREATE_OBJECT_WITH_PROPERTIES_AND_DATA = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 3u)
    ...
    let WPD_COMMAND_OBJECT_MANAGEMENT_WRITE_OBJECT_DATA = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 4u)
    ...
    let WPD_COMMAND_OBJECT_MANAGEMENT_COMMIT_OBJECT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 5u)
    ...
    let WPD_COMMAND_OBJECT_MANAGEMENT_REVERT_OBJECT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 6u)
    ...
    let WPD_COMMAND_OBJECT_MANAGEMENT_DELETE_OBJECTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 7u)
    ...
    let WPD_COMMAND_OBJECT_MANAGEMENT_MOVE_OBJECTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 8u)
    ...
    let WPD_COMMAND_OBJECT_MANAGEMENT_COPY_OBJECTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 9u)
    ...
    let WPD_COMMAND_OBJECT_MANAGEMENT_UPDATE_OBJECT_WITH_PROPERTIES_AND_DATA = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 10u)
    ...
    let WPD_PROPERTY_OBJECT_MANAGEMENT_CREATION_PROPERTIES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1001u)
    ...
    let WPD_PROPERTY_OBJECT_MANAGEMENT_CONTEXT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1002u)
    
    ///
    /// WPD_PROPERTY_OBJECT_MANAGEMENT_NUM_BYTES_TO_WRITE  
    ///   [ VT_UI4 ] Specifies the number of bytes the client is requesting to write.
    let WPD_PROPERTY_OBJECT_MANAGEMENT_NUM_BYTES_TO_WRITE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1003u)
    ...
    let WPD_PROPERTY_OBJECT_MANAGEMENT_NUM_BYTES_WRITTEN = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1004u)
    ...
    let WPD_PROPERTY_OBJECT_MANAGEMENT_DATA = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1005u)
    ...
    let WPD_PROPERTY_OBJECT_MANAGEMENT_OBJECT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1006u)
    ...
    let WPD_PROPERTY_OBJECT_MANAGEMENT_DELETE_OPTIONS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1007u)
    ...
    let WPD_PROPERTY_OBJECT_MANAGEMENT_OPTIMAL_TRANSFER_BUFFER_SIZE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1008u)
    ...
    let WPD_PROPERTY_OBJECT_MANAGEMENT_OBJECT_IDS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1009u)
    ...
    let WPD_PROPERTY_OBJECT_MANAGEMENT_DELETE_RESULTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1010u)
    ...
    let WPD_PROPERTY_OBJECT_MANAGEMENT_DESTINATION_FOLDER_OBJECT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1011u)
    
    ///
    /// WPD_PROPERTY_OBJECT_MANAGEMENT_MOVE_RESULTS  
    ///   [ VT_UNKNOWN ] IPortableDevicePropVariantCollection of type VT_ERROR, where each element is the HRESULT indicating the success or failure of the operation.
    let WPD_PROPERTY_OBJECT_MANAGEMENT_MOVE_RESULTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1012u)
    
    ///
    /// WPD_PROPERTY_OBJECT_MANAGEMENT_COPY_RESULTS  
    ///   [ VT_UNKNOWN ] IPortableDevicePropVariantCollection of type VT_ERROR, where each element is the HRESULT indicating the success or failure of the operation.
    let WPD_PROPERTY_OBJECT_MANAGEMENT_COPY_RESULTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1013u)
    ...
    let WPD_PROPERTY_OBJECT_MANAGEMENT_UPDATE_PROPERTIES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1014u)
    ...
    let WPD_PROPERTY_OBJECT_MANAGEMENT_PROPERTY_KEYS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1015u)
    ...
    let WPD_PROPERTY_OBJECT_MANAGEMENT_OBJECT_FORMAT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 1016u)
    ...
    let WPD_OPTION_OBJECT_MANAGEMENT_RECURSIVE_DELETE_SUPPORTED = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_OBJECT_MANAGEMENT, pid = 5001u)
    ...
    ///
    let WPD_CATEGORY_CAPABILITIES = 
        new System.Guid(0x0CABEC78u, 0x6B74us, 0x41C6us, 0x92uy, 0x16uy, 0x26uy, 0x39uy, 0xD1uy, 0xFCuy, 0xE3uy, 0x56uy)
    ...
    let WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_COMMANDS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 2u)
    ...
    let WPD_COMMAND_CAPABILITIES_GET_COMMAND_OPTIONS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 3u)
    ...
    let WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_FUNCTIONAL_CATEGORIES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 4u)
    ...
    let WPD_COMMAND_CAPABILITIES_GET_FUNCTIONAL_OBJECTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 5u)
    ...
    let WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_CONTENT_TYPES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 6u)
    ...
    let WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_FORMATS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 7u)
    ...
    let WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_FORMAT_PROPERTIES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 8u)
    ...
    let WPD_COMMAND_CAPABILITIES_GET_FIXED_PROPERTY_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 9u)
    ...
    let WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_EVENTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 10u)
    ...
    let WPD_COMMAND_CAPABILITIES_GET_EVENT_OPTIONS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 11u)
    ...
    let WPD_PROPERTY_CAPABILITIES_SUPPORTED_COMMANDS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1001u)
    ...
    let WPD_PROPERTY_CAPABILITIES_COMMAND = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1002u)
    ...
    let WPD_PROPERTY_CAPABILITIES_COMMAND_OPTIONS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1003u)
    ...
    let WPD_PROPERTY_CAPABILITIES_FUNCTIONAL_CATEGORIES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1004u)
    ...
    let WPD_PROPERTY_CAPABILITIES_FUNCTIONAL_CATEGORY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1005u)
    ...
    let WPD_PROPERTY_CAPABILITIES_FUNCTIONAL_OBJECTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1006u)
    ...
    let WPD_PROPERTY_CAPABILITIES_CONTENT_TYPES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1007u)
    ...
    let WPD_PROPERTY_CAPABILITIES_CONTENT_TYPE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1008u)
    ...
    let WPD_PROPERTY_CAPABILITIES_FORMATS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1009u)
    ...
    let WPD_PROPERTY_CAPABILITIES_FORMAT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1010u)
    ...
    let WPD_PROPERTY_CAPABILITIES_PROPERTY_KEYS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1011u)
    ...
    let WPD_PROPERTY_CAPABILITIES_PROPERTY_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1012u)
    ...
    let WPD_PROPERTY_CAPABILITIES_SUPPORTED_EVENTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1013u)
    ...
    let WPD_PROPERTY_CAPABILITIES_EVENT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1014u)
    ...
    let WPD_PROPERTY_CAPABILITIES_EVENT_OPTIONS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_CAPABILITIES, pid = 1015u)
    ...
    ///
    let WPD_CATEGORY_STORAGE = 
        new System.Guid(0xD8F907A6u, 0x34CCus, 0x45FAus, 0x97uy, 0xFBuy, 0xD0uy, 0x07uy, 0xFAuy, 0x47uy, 0xECuy, 0x94uy)
    ...
    let WPD_PROPERTY_STORAGE_OBJECT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_STORAGE, pid = 1001u)
    ...
    let WPD_PROPERTY_STORAGE_DESTINATION_OBJECT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_STORAGE, pid = 1002u)
    ...
    ///
    let WPD_CATEGORY_SMS = 
        new System.Guid(0xAFC25D66u, 0xFE0Dus, 0x4114us, 0x90uy, 0x97uy, 0x97uy, 0x0Cuy, 0x93uy, 0xE9uy, 0x20uy, 0xD1uy)
    ...
    let WPD_PROPERTY_SMS_BINARY_MESSAGE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SMS, pid = 1004u)
    ...
    let WPD_OPTION_SMS_BINARY_MESSAGE_SUPPORTED = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SMS, pid = 5001u)
    ...
    /// 
    ///
    let WPD_CATEGORY_STILL_IMAGE_CAPTURE = 
        new System.Guid(0x4FCD6982u, 0x22A2us, 0x4B05us, 0xA4uy, 0x8Buy, 0x62uy, 0xD3uy, 0x8Buy, 0xF2uy, 0x7Buy, 0x32uy)
    ...
    let WPD_COMMAND_STILL_IMAGE_CAPTURE_INITIATE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_STILL_IMAGE_CAPTURE, pid = 2u)
    ...
    /// 
    ///
    let WPD_CATEGORY_MEDIA_CAPTURE = 
        new System.Guid(0x59B433BAu, 0xFE44us, 0x4D8Dus, 0x80uy, 0x8Cuy, 0x6Buy, 0xCBuy, 0x9Buy, 0x0Fuy, 0x15uy, 0xE8uy)
    ...
    let WPD_COMMAND_MEDIA_CAPTURE_START = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_MEDIA_CAPTURE, pid = 2u)
    ...
    let WPD_COMMAND_MEDIA_CAPTURE_STOP = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_MEDIA_CAPTURE, pid = 3u)
    ...
    let WPD_COMMAND_MEDIA_CAPTURE_PAUSE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_MEDIA_CAPTURE, pid = 4u)
    ...
    ///
    let WPD_CATEGORY_DEVICE_HINTS = 
        new System.Guid(0x0D5FB92Bu, 0xCB46us, 0x4C4Fus, 0x83uy, 0x43uy, 0x0Buy, 0xC3uy, 0xD3uy, 0xF1uy, 0x7Cuy, 0x84uy)
    ...
    let WPD_COMMAND_DEVICE_HINTS_GET_CONTENT_LOCATION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_DEVICE_HINTS, pid = 2u)
    ...
    let WPD_PROPERTY_DEVICE_HINTS_CONTENT_TYPE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_DEVICE_HINTS, pid = 1001u)
    ...
    let WPD_PROPERTY_DEVICE_HINTS_CONTENT_LOCATIONS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_DEVICE_HINTS, pid = 1002u)
    ...
    ///
    let WPD_CLASS_EXTENSION_V1 = 
        new System.Guid(0x33FB0D11u, 0x64A3us, 0x4FACus, 0xB4uy, 0xC7uy, 0x3Duy, 0xFEuy, 0xAAuy, 0x99uy, 0xB0uy, 0x51uy)
    ...
    let WPD_COMMAND_CLASS_EXTENSION_WRITE_DEVICE_INFORMATION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_V1, pid = 2u)
    ...
    let WPD_PROPERTY_CLASS_EXTENSION_DEVICE_INFORMATION_VALUES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_V1, pid = 1001u)
    ...
    let WPD_PROPERTY_CLASS_EXTENSION_DEVICE_INFORMATION_WRITE_RESULTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_V1, pid = 1002u)
    ...
    /// The commands in this category relate to the WPD device class extension.
    ///
    let WPD_CLASS_EXTENSION_V2 = 
        new System.Guid(0x7F0779B5u, 0xFA2Bus, 0x4766us, 0x9Cuy, 0xB2uy, 0xF7uy, 0x3Buy, 0xA3uy, 0x0Buy, 0x67uy, 0x58uy)
    ...
    let WPD_COMMAND_CLASS_EXTENSION_REGISTER_SERVICE_INTERFACES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_V2, pid = 2u)
    ...
    let WPD_COMMAND_CLASS_EXTENSION_UNREGISTER_SERVICE_INTERFACES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_V2, pid = 3u)
    ...
    let WPD_PROPERTY_CLASS_EXTENSION_SERVICE_OBJECT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_V2, pid = 1001u)
    ...
    let WPD_PROPERTY_CLASS_EXTENSION_SERVICE_INTERFACES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_V2, pid = 1002u)
    ...
    let WPD_PROPERTY_CLASS_EXTENSION_SERVICE_REGISTRATION_RESULTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CLASS_EXTENSION_V2, pid = 1003u)
    ...
    ///
    let WPD_CATEGORY_NETWORK_CONFIGURATION = 
        new System.Guid(0x78F9C6FCu, 0x79B8us, 0x473Cus, 0x90uy, 0x60uy, 0x6Buy, 0xD2uy, 0x3Duy, 0xD0uy, 0x72uy, 0xC4uy)
    ...
    let WPD_COMMAND_GENERATE_KEYPAIR = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_NETWORK_CONFIGURATION, pid = 2u)
    ...
    let WPD_COMMAND_COMMIT_KEYPAIR = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_NETWORK_CONFIGURATION, pid = 3u)
    ...
    let WPD_COMMAND_PROCESS_WIRELESS_PROFILE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_NETWORK_CONFIGURATION, pid = 4u)
    
    ///
    /// WPD_PROPERTY_PUBLIC_KEY  
    ///   [ VT_VECTOR | VT_UI1 ] A public key generated for RSA key exchange.
    let WPD_PROPERTY_PUBLIC_KEY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_NETWORK_CONFIGURATION, pid = 1001u)
    ...
    ///
    let WPD_CATEGORY_SERVICE_COMMON = 
        new System.Guid(0x322F071Du, 0x36EFus, 0x477Fus, 0xB4uy, 0xB5uy, 0x6Fuy, 0x52uy, 0xD7uy, 0x34uy, 0xBAuy, 0xEEuy)
    ...
    let WPD_COMMAND_SERVICE_COMMON_GET_SERVICE_OBJECT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_COMMON, pid = 2u)
    
    ///
    /// WPD_PROPERTY_SERVICE_OBJECT_ID  
    ///   [ VT_LPWSTR ] Contains the service object identifier.
    let WPD_PROPERTY_SERVICE_OBJECT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_COMMON, pid = 1001u)
    ...
    ///
    let WPD_CATEGORY_SERVICE_CAPABILITIES = 
        new System.Guid(0x24457E74u, 0x2E9Fus, 0x44F9us, 0x8Cuy, 0x57uy, 0x1Duy, 0x1Buy, 0xCBuy, 0x17uy, 0x0Buy, 0x89uy)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_METHODS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 2u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_METHODS_BY_FORMAT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 3u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_METHOD_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 4u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_METHOD_PARAMETER_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 5u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_FORMATS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 6u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 7u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_FORMAT_PROPERTIES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 8u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_PROPERTY_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 9u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_EVENTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 10u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_EVENT_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 11u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_EVENT_PARAMETER_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 12u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_INHERITED_SERVICES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 13u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_RENDERING_PROFILES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 14u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_COMMANDS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 15u)
    ...
    let WPD_COMMAND_SERVICE_CAPABILITIES_GET_COMMAND_OPTIONS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 16u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_METHODS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1001u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_FORMAT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1002u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_METHOD = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1003u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_METHOD_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1004u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_PARAMETER = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1005u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_PARAMETER_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1006u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_FORMATS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1007u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_FORMAT_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1008u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_PROPERTY_KEYS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1009u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_PROPERTY_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1010u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_EVENTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1011u)
    
    ///
    /// WPD_PROPERTY_SERVICE_CAPABILITIES_EVENT  
    ///   [ VT_CLSID ] Indicates the event the caller is interested in.
    let WPD_PROPERTY_SERVICE_CAPABILITIES_EVENT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1012u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_EVENT_ATTRIBUTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1013u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_INHERITANCE_TYPE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1014u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_INHERITED_SERVICES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1015u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_RENDERING_PROFILES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1016u)
    ...
    let WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_COMMANDS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1017u)
    
    ///
    /// WPD_PROPERTY_SERVICE_CAPABILITIES_COMMAND  
    ///   [ VT_UNKNOWN ] Indicates the command whose options the caller is interested in.
    let WPD_PROPERTY_SERVICE_CAPABILITIES_COMMAND = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1018u)
    
    ///
    /// WPD_PROPERTY_SERVICE_CAPABILITIES_COMMAND_OPTIONS  
    ///   [ VT_UNKNOWN ] Contains an IPortableDeviceValues with the relevant command options.
    let WPD_PROPERTY_SERVICE_CAPABILITIES_COMMAND_OPTIONS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_CAPABILITIES, pid = 1019u)
    ...
    ///
    let WPD_CATEGORY_SERVICE_METHODS = 
        new System.Guid(0x2D521CA8u, 0xC1B0us, 0x4268us, 0xA3uy, 0x42uy, 0xCFuy, 0x19uy, 0x32uy, 0x15uy, 0x69uy, 0xBCuy)
    ...
    let WPD_COMMAND_SERVICE_METHODS_START_INVOKE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 2u)
    ...
    let WPD_COMMAND_SERVICE_METHODS_CANCEL_INVOKE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 3u)
    ...
    let WPD_COMMAND_SERVICE_METHODS_END_INVOKE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 4u)
    
    ///
    /// WPD_PROPERTY_SERVICE_METHOD  
    ///   [ VT_CLSID ] Indicates the method to invoke.
    let WPD_PROPERTY_SERVICE_METHOD = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 1001u)
    ...
    let WPD_PROPERTY_SERVICE_METHOD_PARAMETER_VALUES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 1002u)
    ...
    let WPD_PROPERTY_SERVICE_METHOD_RESULT_VALUES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 1003u)
    ...
    let WPD_PROPERTY_SERVICE_METHOD_CONTEXT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 1004u)
    ...
    let WPD_PROPERTY_SERVICE_METHOD_HRESULT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 1005u)
    
    //// Category placeholder for WPD_RESOURCE_DEFAULT
    let WPD_RESOURCE_DEFAULT_Guid = 
        new System.Guid(0xE81E79BEu, 0x34F0us, 0x41BFus, 0xB5uy, 0x3Fuy, 0xF1uy, 0xA0uy, 0x6Auy, 0xE8uy, 0x78uy, 0x42uy)
    ...
    let WPD_RESOURCE_CONTACT_PHOTO_Guid = 
        new System.Guid(0x2C4D6803u, 0x80EAus, 0x4580us, 0xAFuy, 0x9Auy, 0x5Buy, 0xE1uy, 0xA2uy, 0x3Euy, 0xDDuy, 0xCBuy)
    
    ///
    ///  WPD_RESOURCE_CONTACT_PHOTO 
    /// Represents the contact's photo data.
    let WPD_RESOURCE_CONTACT_PHOTO = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RESOURCE_CONTACT_PHOTO_Guid, pid = 0u)
    
    //// Category placeholder for WPD_RESOURCE_THUMBNAIL
    let WPD_RESOURCE_THUMBNAIL_Guid = 
        new System.Guid(0xC7C407BAu, 0x98FAus, 0x46B5us, 0x99uy, 0x60uy, 0x23uy, 0xFEuy, 0xC1uy, 0x24uy, 0xCFuy, 0xDEuy)
    ...
    let WPD_RESOURCE_ICON_Guid = 
        new System.Guid(0xF195FED8u, 0xAA28us, 0x4EE3us, 0xB1uy, 0x53uy, 0xE1uy, 0x82uy, 0xDDuy, 0x5Euy, 0xDCuy, 0x39uy)
    ...
    let WPD_RESOURCE_AUDIO_CLIP_Guid = 
        new System.Guid(0x3BC13982u, 0x85B1us, 0x48E0us, 0x95uy, 0xA6uy, 0x8Duy, 0x3Auy, 0xD0uy, 0x6Buy, 0xE1uy, 0x17uy)
    
    ///
    ///  WPD_RESOURCE_AUDIO_CLIP 
    /// Represents an audio sample data for an object.
    let WPD_RESOURCE_AUDIO_CLIP = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RESOURCE_AUDIO_CLIP_Guid, pid = 0u)
    
    //// Category placeholder for WPD_RESOURCE_ALBUM_ART
    let WPD_RESOURCE_ALBUM_ART_Guid = 
        new System.Guid(0xF02AA354u, 0x2300us, 0x4E2Dus, 0xA1uy, 0xB9uy, 0x3Buy, 0x67uy, 0x30uy, 0xF7uy, 0xFAuy, 0x21uy)
    ...
    let WPD_RESOURCE_GENERIC_Guid = 
        new System.Guid(0xB9B9F515u, 0xBA70us, 0x4647us, 0x94uy, 0xDCuy, 0xFAuy, 0x49uy, 0x25uy, 0xE9uy, 0x5Auy, 0x07uy)
    ...
    let WPD_RESOURCE_VIDEO_CLIP_Guid = 
        new System.Guid(0xB566EE42u, 0x6368us, 0x4290us, 0x86uy, 0x62uy, 0x70uy, 0x18uy, 0x2Fuy, 0xB7uy, 0x9Fuy, 0x20uy)
    
    ///
    ///  WPD_RESOURCE_VIDEO_CLIP 
    /// Represents a video sample for an object.
    let WPD_RESOURCE_VIDEO_CLIP = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RESOURCE_VIDEO_CLIP_Guid, pid = 0u)
    
    //// Category placeholder for WPD_RESOURCE_BRANDING_ART
    let WPD_RESOURCE_BRANDING_ART_Guid = 
        new System.Guid(0xB633B1AEu, 0x6CAFus, 0x4A87us, 0x95uy, 0x89uy, 0x22uy, 0xDEuy, 0xD6uy, 0xDDuy, 0x58uy, 0x99uy)
    ...
    let WPD_RESOURCE_BRANDING_ART = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_RESOURCE_BRANDING_ART_Guid, pid = 0u)
    ...
    let WPD_OBJECT_FORMAT_PROPERTIES_ONLY = 
        new System.Guid(0x30010000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    ...
    let WPD_OBJECT_FORMAT_UNSPECIFIED = 
        new System.Guid(0x30000000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_SCRIPT
    ///   A device model-specific script
    ///   Device Services Format: FORMAT_DeviceScript
    let WPD_OBJECT_FORMAT_SCRIPT = 
        new System.Guid(0x30020000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_EXECUTABLE
    ///   A device model-specific binary executable
    ///   Device Services Format: FORMAT_DeviceExecutable
    let WPD_OBJECT_FORMAT_EXECUTABLE = 
        new System.Guid(0x30030000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_TEXT
    ///   A text file
    ///   Device Services Format: FORMAT_TextDocument
    let WPD_OBJECT_FORMAT_TEXT = 
        new System.Guid(0x30040000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_HTML
    ///   A HyperText Markup Language file (text)
    ///   Device Services Format: FORMAT_HTMLDocument
    let WPD_OBJECT_FORMAT_HTML = 
        new System.Guid(0x30050000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_DPOF
    ///   A Digital Print Order File (text)
    ///   Device Services Format: FORMAT_DPOFDocument
    let WPD_OBJECT_FORMAT_DPOF = 
        new System.Guid(0x30060000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_AIFF
    ///   Audio file format
    ///   Device Services Format: FORMAT_AIFFFile
    let WPD_OBJECT_FORMAT_AIFF = 
        new System.Guid(0x30070000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_WAVE
    ///   Audio file format
    ///   Device Services Format: FORMAT_WAVFile
    let WPD_OBJECT_FORMAT_WAVE = 
        new System.Guid(0x30080000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_MP3
    ///   Audio file format
    ///   Device Services Format: FORMAT_MP3File
    let WPD_OBJECT_FORMAT_MP3 = 
        new System.Guid(0x30090000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_AVI
    ///   Video file format
    ///   Device Services Format: FORMAT_AVIFile
    let WPD_OBJECT_FORMAT_AVI = 
        new System.Guid(0x300A0000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_MPEG
    ///   Video file format
    ///   Device Services Format: FORMAT_MPEGFile
    let WPD_OBJECT_FORMAT_MPEG = 
        new System.Guid(0x300B0000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_ASF
    ///   Video file format (Microsoft Advanced Streaming Format)
    ///   Device Services Format: FORMAT_ASFFile
    let WPD_OBJECT_FORMAT_ASF = 
        new System.Guid(0x300C0000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_EXIF
    ///   Image file format (Exchangeable File Format), JEIDA standard
    ///   Device Services Format: FORMAT_EXIFImage
    let WPD_OBJECT_FORMAT_EXIF = 
        new System.Guid(0x38010000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    ...
    let WPD_OBJECT_FORMAT_TIFFEP = 
        new System.Guid(0x38020000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_FLASHPIX
    ///   Image file format (Structured Storage Image Format)
    ///   Device Services Format: FORMAT_FlashPixImage
    let WPD_OBJECT_FORMAT_FLASHPIX = 
        new System.Guid(0x38030000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_BMP
    ///   Image file format (Microsoft Windows Bitmap file)
    ///   Device Services Format: FORMAT_BMPImage
    let WPD_OBJECT_FORMAT_BMP = 
        new System.Guid(0x38040000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_CIFF
    ///   Image file format (Canon Camera Image File Format)
    ///   Device Services Format: FORMAT_CIFFImage
    let WPD_OBJECT_FORMAT_CIFF = 
        new System.Guid(0x38050000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_GIF
    ///   Image file format (Graphics Interchange Format)
    ///   Device Services Format: FORMAT_GIFImage
    let WPD_OBJECT_FORMAT_GIF = 
        new System.Guid(0x38070000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_JFIF
    ///   Image file format (JPEG Interchange Format)
    ///   Device Services Format: FORMAT_JFIFImage
    let WPD_OBJECT_FORMAT_JFIF = 
        new System.Guid(0x38080000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_PCD
    ///   Image file format (PhotoCD Image Pac)
    ///   Device Services Format: FORMAT_PCDImage
    let WPD_OBJECT_FORMAT_PCD = 
        new System.Guid(0x38090000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_PICT
    ///   Image file format (Quickdraw Image Format)
    ///   Device Services Format: FORMAT_PICTImage
    let WPD_OBJECT_FORMAT_PICT = 
        new System.Guid(0x380A0000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_PNG
    ///   Image file format (Portable Network Graphics)
    ///   Device Services Format: FORMAT_PNGImage
    let WPD_OBJECT_FORMAT_PNG = 
        new System.Guid(0x380B0000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_TIFF
    ///   Image file format (Tag Image File Format)
    ///   Device Services Format: FORMAT_TIFFImage
    let WPD_OBJECT_FORMAT_TIFF = 
        new System.Guid(0x380D0000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    ...
    let WPD_OBJECT_FORMAT_TIFFIT = 
        new System.Guid(0x380E0000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_JP2
    ///   Image file format (JPEG2000 Baseline File Format)
    ///   Device Services Format: FORMAT_JP2Image
    let WPD_OBJECT_FORMAT_JP2 = 
        new System.Guid(0x380F0000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_JPX
    ///   Image file format (JPEG2000 Extended File Format)
    ///   Device Services Format: FORMAT_JPXImage
    let WPD_OBJECT_FORMAT_JPX = 
        new System.Guid(0x38100000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    ...
    let WPD_OBJECT_FORMAT_WBMP = 
        new System.Guid(0xB8030000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_JPEGXR
    ///   Image file format (JPEG XR, also known as HD Photo)
    ///   Device Services Format: FORMAT_JPEGXRImage
    let WPD_OBJECT_FORMAT_JPEGXR = 
        new System.Guid(0xB8040000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_WINDOWSIMAGEFORMAT
    ///   Image file format
    ///   Device Services Format: FORMAT_HDPhotoImage
    let WPD_OBJECT_FORMAT_WINDOWSIMAGEFORMAT = 
        new System.Guid(0xB8810000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_WMA
    ///   Audio file format (Windows Media Audio)
    ///   Device Services Format: FORMAT_WMAFile
    let WPD_OBJECT_FORMAT_WMA = 
        new System.Guid(0xB9010000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_WMV
    ///   Video file format (Windows Media Video)
    ///   Device Services Format: FORMAT_WMVFile
    let WPD_OBJECT_FORMAT_WMV = 
        new System.Guid(0xB9810000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_WPLPLAYLIST
    ///   Playlist file format
    ///   Device Services Format: FORMAT_WPLPlaylist
    let WPD_OBJECT_FORMAT_WPLPLAYLIST = 
        new System.Guid(0xBA100000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_M3UPLAYLIST
    ///   Playlist file format
    ///   Device Services Format: FORMAT_M3UPlaylist
    let WPD_OBJECT_FORMAT_M3UPLAYLIST = 
        new System.Guid(0xBA110000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_MPLPLAYLIST
    ///   Playlist file format
    ///   Device Services Format: FORMAT_MPLPlaylist
    let WPD_OBJECT_FORMAT_MPLPLAYLIST = 
        new System.Guid(0xBA120000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_ASXPLAYLIST
    ///   Playlist file format
    ///   Device Services Format: FORMAT_ASXPlaylist
    let WPD_OBJECT_FORMAT_ASXPLAYLIST = 
        new System.Guid(0xBA130000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_PLSPLAYLIST
    ///   Playlist file format
    ///   Device Services Format: FORMAT_PSLPlaylist
    let WPD_OBJECT_FORMAT_PLSPLAYLIST = 
        new System.Guid(0xBA140000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    ...
    let WPD_OBJECT_FORMAT_ABSTRACT_CONTACT_GROUP = 
        new System.Guid(0xBA060000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_ABSTRACT_MEDIA_CAST
    ///   MediaCast file format
    ///   Device Services Format: FORMAT_AbstractMediacast
    let WPD_OBJECT_FORMAT_ABSTRACT_MEDIA_CAST = 
        new System.Guid(0xBA0B0000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_VCALENDAR1
    ///   VCALENDAR file format (VCALENDAR Version 1)
    ///   Device Services Format: FORMAT_VCalendar1
    let WPD_OBJECT_FORMAT_VCALENDAR1 = 
        new System.Guid(0xBE020000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_ICALENDAR
    ///   ICALENDAR file format (VCALENDAR Version 2)
    ///   Device Services Format: FORMAT_ICalendar
    let WPD_OBJECT_FORMAT_ICALENDAR = 
        new System.Guid(0xBE030000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_ABSTRACT_CONTACT
    ///   Abstract contact file format
    ///   Device Services Format: FORMAT_AbstractContact
    let WPD_OBJECT_FORMAT_ABSTRACT_CONTACT = 
        new System.Guid(0xBB810000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_VCARD2
    ///   VCARD file format (VCARD Version 2)
    ///   Device Services Format: FORMAT_VCard2Contact
    let WPD_OBJECT_FORMAT_VCARD2 = 
        new System.Guid(0xBB820000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_VCARD3
    ///   VCARD file format (VCARD Version 3)
    ///   Device Services Format: FORMAT_VCard3Contact
    let WPD_OBJECT_FORMAT_VCARD3 = 
        new System.Guid(0xBB830000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_XML
    ///   XML file format.
    ///   Device Services Format: FORMAT_XMLDocument
    let WPD_OBJECT_FORMAT_XML = 
        new System.Guid(0xBA820000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_AAC
    ///   Audio file format
    ///   Device Services Format: FORMAT_AACFile
    let WPD_OBJECT_FORMAT_AAC = 
        new System.Guid(0xB9030000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_AUDIBLE
    ///   Audio file format
    ///   Device Services Format: FORMAT_AudibleFile
    let WPD_OBJECT_FORMAT_AUDIBLE = 
        new System.Guid(0xB9040000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_FLAC
    ///   Audio file format
    ///   Device Services Format: FORMAT_FLACFile
    let WPD_OBJECT_FORMAT_FLAC = 
        new System.Guid(0xB9060000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_QCELP
    ///   Audio file format (Qualcomm Code Excited Linear Prediction)
    ///   Device Services Format: FORMAT_QCELPFile
    let WPD_OBJECT_FORMAT_QCELP = 
        new System.Guid(0xB9070000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_AMR
    ///   Audio file format (Adaptive Multi-Rate audio codec)
    ///   Device Services Format: FORMAT_AMRFile
    let WPD_OBJECT_FORMAT_AMR = 
        new System.Guid(0xB9080000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_OGG
    ///   Audio file format
    ///   Device Services Format: FORMAT_OGGFile
    let WPD_OBJECT_FORMAT_OGG = 
        new System.Guid(0xB9020000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_MP4
    ///   Audio or Video file format
    ///   Device Services Format: FORMAT_MPEG4File
    let WPD_OBJECT_FORMAT_MP4 = 
        new System.Guid(0xB9820000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_MP2
    ///   Audio or Video file format
    ///   Device Services Format: FORMAT_MPEG2File
    let WPD_OBJECT_FORMAT_MP2 = 
        new System.Guid(0xB9830000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_MICROSOFT_WORD
    ///   Microsoft Office Word Document file format.
    ///   Device Services Format: FORMAT_WordDocument
    let WPD_OBJECT_FORMAT_MICROSOFT_WORD = 
        new System.Guid(0xBA830000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_MHT_COMPILED_HTML
    ///   MHT Compiled HTML Document file format.
    ///   Device Services Format: FORMAT_MHTDocument
    let WPD_OBJECT_FORMAT_MHT_COMPILED_HTML = 
        new System.Guid(0xBA840000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_MICROSOFT_EXCEL
    ///   Microsoft Office Excel Document file format.
    ///   Device Services Format: FORMAT_ExcelDocument
    let WPD_OBJECT_FORMAT_MICROSOFT_EXCEL = 
        new System.Guid(0xBA850000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    ...
    let WPD_OBJECT_FORMAT_MICROSOFT_POWERPOINT = 
        new System.Guid(0xBA860000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_3GP
    ///   Audio or Video file format
    ///   Device Services Format: FORMAT_3GPPFile
    let WPD_OBJECT_FORMAT_3GP = 
        new System.Guid(0xB9840000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_3G2
    ///   Audio or Video file format
    ///   Device Services Format: FORMAT_3GPP2File
    let WPD_OBJECT_FORMAT_3G2 = 
        new System.Guid(0xB9850000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_AVCHD
    ///   Audio or Video file format
    ///   Device Services Format: FORMAT_AVCHDFile
    let WPD_OBJECT_FORMAT_AVCHD = 
        new System.Guid(0xB9860000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_ATSCTS
    ///   Audio or Video file format
    ///   Device Services Format: FORMAT_ATSCTSFile
    let WPD_OBJECT_FORMAT_ATSCTS = 
        new System.Guid(0xB9870000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_DVBTS
    ///   Audio or Video file format
    ///   Device Services Format: FORMAT_DVBTSFile
    let WPD_OBJECT_FORMAT_DVBTS = 
        new System.Guid(0xB9880000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xC5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    
    ///
    /// WPD_OBJECT_FORMAT_MKV
    ///   Audio or Video file format
    ///   Device Services Format: FORMAT_MKVFile
    let WPD_OBJECT_FORMAT_MKV = 
        new System.Guid(0xB9900000u, 0xAE6Cus, 0x4804us, 0x98uy, 0xBAuy, 0xc5uy, 0x7Buy, 0x46uy, 0x96uy, 0x5Fuy, 0xE7uy)
    ...
    let WPD_OBJECT_PERSISTENT_UNIQUE_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_PROPERTIES_V1, pid = 5u)
    ...
    let WPD_OBJECT_ORIGINAL_FILE_NAME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_PROPERTIES_V1, pid = 12u)
    ...
    let WPD_OBJECT_NON_CONSUMABLE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_PROPERTIES_V1, pid = 13u)
    ...
    let WPD_OBJECT_IS_DRM_PROTECTED = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_PROPERTIES_V1, pid = 17u)
    ...
    let WPD_OBJECT_BACK_REFERENCES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_PROPERTIES_V1, pid = 21u)
    ...
    let WPD_OBJECT_LANGUAGE_LOCALE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_PROPERTIES_V1, pid = 27u)
    ...
    ///
    let WPD_FOLDER_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0x7E9A7ABFu, 0xE568us, 0x4B34us, 0xAAuy, 0x2Fuy, 0x13uy, 0xBBuy, 0x12uy, 0xABuy, 0x17uy, 0x7Duy)
    ...
    let WPD_FOLDER_CONTENT_TYPES_ALLOWED = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_FOLDER_OBJECT_PROPERTIES_V1, pid = 2u)
    ...
    ///
    let WPD_IMAGE_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0x63D64908u, 0x9FA1us, 0x479Fus, 0x85uy, 0xBAuy, 0x99uy, 0x52uy, 0x21uy, 0x64uy, 0x47uy, 0xDBuy)
    ...
    let WPD_IMAGE_CROPPED_STATUS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_IMAGE_OBJECT_PROPERTIES_V1, pid = 4u)
    ...
    let WPD_IMAGE_COLOR_CORRECTED_STATUS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_IMAGE_OBJECT_PROPERTIES_V1, pid = 5u)
    ...
    let WPD_IMAGE_EXPOSURE_TIME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_IMAGE_OBJECT_PROPERTIES_V1, pid = 7u)
    ...
    let WPD_IMAGE_EXPOSURE_INDEX = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_IMAGE_OBJECT_PROPERTIES_V1, pid = 8u)
    ...
    let WPD_IMAGE_HORIZONTAL_RESOLUTION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_IMAGE_OBJECT_PROPERTIES_V1, pid = 9u)
    ...
    let WPD_IMAGE_VERTICAL_RESOLUTION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_IMAGE_OBJECT_PROPERTIES_V1, pid = 10u)
    ...
    ///
    let WPD_DOCUMENT_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0x0B110203u, 0xEB95us, 0x4F02us, 0x93uy, 0xE0uy, 0x97uy, 0xC6uy, 0x31uy, 0x49uy, 0x3Auy, 0xD5uy)
    ...
    ///
    let WPD_MEDIA_PROPERTIES_V1 = 
        new System.Guid(0x2ED8BA05u, 0x0AD3us, 0x42DCus, 0xB0uy, 0xD0uy, 0xBCuy, 0x95uy, 0xACuy, 0x39uy, 0x6Auy, 0xC8uy)
    ...
    let WPD_MEDIA_SUBSCRIPTION_CONTENT_ID = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_MEDIA_PROPERTIES_V1, pid = 5u)
    ...
    let WPD_MEDIA_LAST_ACCESSED_TIME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_MEDIA_PROPERTIES_V1, pid = 8u)
    ...
    let WPD_MEDIA_EFFECTIVE_RATING = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_MEDIA_PROPERTIES_V1, pid = 12u)
    ...
    let WPD_MEDIA_USER_EFFECTIVE_RATING = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_MEDIA_PROPERTIES_V1, pid = 17u)
    ...
    let WPD_MEDIA_ENCODING_PROFILE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_MEDIA_PROPERTIES_V1, pid = 21u)
    ...
    let WPD_MEDIA_AUDIO_ENCODING_PROFILE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_MEDIA_PROPERTIES_V1, pid = 49u)
    ...
    ///
    let WPD_CONTACT_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0xFBD4FDABu, 0x987Dus, 0x4777us, 0xB3uy, 0xF9uy, 0x72uy, 0x61uy, 0x85uy, 0xA9uy, 0x31uy, 0x2Buy)
    ...
    let WPD_CONTACT_DISPLAY_NAME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 2u)
    ...
    let WPD_CONTACT_FIRST_NAME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 3u)
    ...
    let WPD_CONTACT_MIDDLE_NAMES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 4u)
    ...
    let WPD_CONTACT_LAST_NAME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 5u)
    ...
    let WPD_CONTACT_PREFIX = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 6u)
    ...
    let WPD_CONTACT_SUFFIX = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 7u)
    ...
    let WPD_CONTACT_PHONETIC_FIRST_NAME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 8u)
    ...
    let WPD_CONTACT_PHONETIC_LAST_NAME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 9u)
    ...
    let WPD_CONTACT_PERSONAL_FULL_POSTAL_ADDRESS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 10u)
    ...
    let WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_LINE1 = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 11u)
    ...
    let WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_LINE2 = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 12u)
    ...
    let WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_CITY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 13u)
    ...
    let WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_REGION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 14u)
    ...
    let WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_POSTAL_CODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 15u)
    ...
    let WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_COUNTRY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 16u)
    ...
    let WPD_CONTACT_BUSINESS_FULL_POSTAL_ADDRESS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 17u)
    ...
    let WPD_CONTACT_BUSINESS_POSTAL_ADDRESS_LINE1 = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 18u)
    ...
    let WPD_CONTACT_BUSINESS_POSTAL_ADDRESS_LINE2 = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 19u)
    ...
    let WPD_CONTACT_BUSINESS_POSTAL_ADDRESS_CITY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 20u)
    ...
    let WPD_CONTACT_BUSINESS_POSTAL_ADDRESS_REGION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 21u)
    ...
    let WPD_CONTACT_BUSINESS_POSTAL_ADDRESS_POSTAL_CODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 22u)
    ...
    let WPD_CONTACT_BUSINESS_POSTAL_ADDRESS_COUNTRY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 23u)
    ...
    let WPD_CONTACT_OTHER_FULL_POSTAL_ADDRESS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 24u)
    ...
    let WPD_CONTACT_OTHER_POSTAL_ADDRESS_LINE1 = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 25u)
    ...
    let WPD_CONTACT_OTHER_POSTAL_ADDRESS_LINE2 = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 26u)
    ...
    let WPD_CONTACT_OTHER_POSTAL_ADDRESS_CITY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 27u)
    ...
    let WPD_CONTACT_OTHER_POSTAL_ADDRESS_REGION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 28u)
    ...
    let WPD_CONTACT_OTHER_POSTAL_ADDRESS_POSTAL_CODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 29u)
    ...
    let WPD_CONTACT_OTHER_POSTAL_ADDRESS_POSTAL_COUNTRY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 30u)
    ...
    let WPD_CONTACT_PRIMARY_EMAIL_ADDRESS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 31u)
    ...
    let WPD_CONTACT_PERSONAL_EMAIL = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 32u)
    ...
    let WPD_CONTACT_PERSONAL_EMAIL2 = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 33u)
    ...
    let WPD_CONTACT_BUSINESS_EMAIL = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 34u)
    ...
    let WPD_CONTACT_BUSINESS_EMAIL2 = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 35u)
    ...
    let WPD_CONTACT_OTHER_EMAILS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 36u)
    ...
    let WPD_CONTACT_PRIMARY_PHONE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 37u)
    ...
    let WPD_CONTACT_PERSONAL_PHONE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 38u)
    ...
    let WPD_CONTACT_PERSONAL_PHONE2 = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 39u)
    ...
    let WPD_CONTACT_BUSINESS_PHONE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 40u)
    ...
    let WPD_CONTACT_BUSINESS_PHONE2 = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 41u)
    ...
    let WPD_CONTACT_MOBILE_PHONE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 42u)
    ...
    let WPD_CONTACT_MOBILE_PHONE2 = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 43u)
    ...
    let WPD_CONTACT_PERSONAL_FAX = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 44u)
    ...
    let WPD_CONTACT_BUSINESS_FAX = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 45u)
    ...
    let WPD_CONTACT_PAGER = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 46u)
    ...
    let WPD_CONTACT_OTHER_PHONES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 47u)
    ...
    let WPD_CONTACT_PRIMARY_WEB_ADDRESS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 48u)
    ...
    let WPD_CONTACT_PERSONAL_WEB_ADDRESS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 49u)
    ...
    let WPD_CONTACT_BUSINESS_WEB_ADDRESS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 50u)
    ...
    let WPD_CONTACT_INSTANT_MESSENGER = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 51u)
    ...
    let WPD_CONTACT_INSTANT_MESSENGER2 = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 52u)
    ...
    let WPD_CONTACT_INSTANT_MESSENGER3 = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 53u)
    ...
    let WPD_CONTACT_COMPANY_NAME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 54u)
    ...
    let WPD_CONTACT_PHONETIC_COMPANY_NAME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 55u)
    ...
    let WPD_CONTACT_BIRTHDATE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 57u)
    ...
    let WPD_CONTACT_PRIMARY_FAX = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 58u)
    ...
    let WPD_CONTACT_SPOUSE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 59u)
    ...
    let WPD_CONTACT_CHILDREN = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 60u)
    ...
    let WPD_CONTACT_ASSISTANT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 61u)
    ...
    let WPD_CONTACT_ANNIVERSARY_DATE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 62u)
    ...
    let WPD_CONTACT_RINGTONE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CONTACT_OBJECT_PROPERTIES_V1, pid = 63u)
    ...
    ///
    let WPD_MUSIC_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0xB324F56Au, 0xDC5Dus, 0x46E5us, 0xB6uy, 0xDFuy, 0xD2uy, 0xEAuy, 0x41uy, 0x48uy, 0x88uy, 0xC6uy)
    ...
    let WPD_AUDIO_CHANNEL_COUNT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_MUSIC_OBJECT_PROPERTIES_V1, pid = 10u)
    ...
    let WPD_AUDIO_FORMAT_CODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_MUSIC_OBJECT_PROPERTIES_V1, pid = 11u)
    ...
    let WPD_AUDIO_BIT_DEPTH = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_MUSIC_OBJECT_PROPERTIES_V1, pid = 12u)
    ...
    let WPD_AUDIO_BLOCK_ALIGNMENT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_MUSIC_OBJECT_PROPERTIES_V1, pid = 13u)
    ...
    ///
    let WPD_VIDEO_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0x346F2163u, 0xF998us, 0x4146us, 0x8Buy, 0x01uy, 0xD1uy, 0x9Buy, 0x4Cuy, 0x00uy, 0xDEuy, 0x9Auy)
    ...
    let WPD_VIDEO_RECORDEDTV_STATION_NAME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_VIDEO_OBJECT_PROPERTIES_V1, pid = 4u)
    ...
    let WPD_VIDEO_RECORDEDTV_CHANNEL_NUMBER = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_VIDEO_OBJECT_PROPERTIES_V1, pid = 5u)
    ...
    let WPD_VIDEO_RECORDEDTV_REPEAT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_VIDEO_OBJECT_PROPERTIES_V1, pid = 7u)
    ...
    let WPD_VIDEO_BUFFER_SIZE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_VIDEO_OBJECT_PROPERTIES_V1, pid = 8u)
    ...
    let WPD_VIDEO_KEY_FRAME_DISTANCE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_VIDEO_OBJECT_PROPERTIES_V1, pid = 10u)
    ...
    let WPD_VIDEO_QUALITY_SETTING = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_VIDEO_OBJECT_PROPERTIES_V1, pid = 11u)
    ...
    let WPD_VIDEO_SCAN_TYPE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_VIDEO_OBJECT_PROPERTIES_V1, pid = 12u)
    ...
    let WPD_VIDEO_FOURCC_CODE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_VIDEO_OBJECT_PROPERTIES_V1, pid = 14u)
    ...
    let WPD_VIDEO_FRAMERATE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_VIDEO_OBJECT_PROPERTIES_V1, pid = 15u)
    ...
    ///
    let WPD_COMMON_INFORMATION_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0xB28AE94Bu, 0x05A4us, 0x4E8Eus, 0xBEuy, 0x01uy, 0x72uy, 0xCCuy, 0x7Euy, 0x09uy, 0x9Duy, 0x8Fuy)
    ...
    let WPD_COMMON_INFORMATION_SUBJECT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_COMMON_INFORMATION_OBJECT_PROPERTIES_V1, pid = 2u)
    ...
    let WPD_COMMON_INFORMATION_BODY_TEXT = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_COMMON_INFORMATION_OBJECT_PROPERTIES_V1, pid = 3u)
    ...
    let WPD_COMMON_INFORMATION_PRIORITY = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_COMMON_INFORMATION_OBJECT_PROPERTIES_V1, pid = 4u)
    ...
    let WPD_COMMON_INFORMATION_START_DATETIME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_COMMON_INFORMATION_OBJECT_PROPERTIES_V1, pid = 5u)
    ...
    let WPD_COMMON_INFORMATION_END_DATETIME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_COMMON_INFORMATION_OBJECT_PROPERTIES_V1, pid = 6u)
    ...
    let WPD_COMMON_INFORMATION_NOTES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_COMMON_INFORMATION_OBJECT_PROPERTIES_V1, pid = 7u)
    ...
    ///
    let WPD_MEMO_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0x5FFBFC7Bu, 0x7483us, 0x41ADus, 0xAFuy, 0xB9uy, 0xDAuy, 0x3Fuy, 0x4Euy, 0x59uy, 0x2Buy, 0x8Duy)
    ...
    ///
    let WPD_EMAIL_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0x41F8F65Au, 0x5484us, 0x4782us, 0xB1uy, 0x3Duy, 0x47uy, 0x40uy, 0xDDuy, 0x7Cuy, 0x37uy, 0xC5uy)
    ...
    let WPD_EMAIL_HAS_BEEN_READ = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EMAIL_OBJECT_PROPERTIES_V1, pid = 7u)
    ...
    let WPD_EMAIL_RECEIVED_TIME = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EMAIL_OBJECT_PROPERTIES_V1, pid = 8u)
    ...
    let WPD_EMAIL_HAS_ATTACHMENTS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EMAIL_OBJECT_PROPERTIES_V1, pid = 9u)
    ...
    let WPD_EMAIL_SENDER_ADDRESS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_EMAIL_OBJECT_PROPERTIES_V1, pid = 10u)
    ...
    ///
    let WPD_APPOINTMENT_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0xF99EFD03u, 0x431Dus, 0x40D8us, 0xA1uy, 0xC9uy, 0x4Euy, 0x22uy, 0x0Duy, 0x9Cuy, 0x88uy, 0xD3uy)
    ...
    let WPD_APPOINTMENT_LOCATION = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_APPOINTMENT_OBJECT_PROPERTIES_V1, pid = 3u)
    ...
    let WPD_APPOINTMENT_TYPE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_APPOINTMENT_OBJECT_PROPERTIES_V1, pid = 7u)
    ...
    let WPD_APPOINTMENT_REQUIRED_ATTENDEES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_APPOINTMENT_OBJECT_PROPERTIES_V1, pid = 8u)
    ...
    let WPD_APPOINTMENT_OPTIONAL_ATTENDEES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_APPOINTMENT_OBJECT_PROPERTIES_V1, pid = 9u)
    ...
    let WPD_APPOINTMENT_ACCEPTED_ATTENDEES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_APPOINTMENT_OBJECT_PROPERTIES_V1, pid = 10u)
    ...
    let WPD_APPOINTMENT_RESOURCES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_APPOINTMENT_OBJECT_PROPERTIES_V1, pid = 11u)
    ...
    let WPD_APPOINTMENT_TENTATIVE_ATTENDEES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_APPOINTMENT_OBJECT_PROPERTIES_V1, pid = 12u)
    ...
    let WPD_APPOINTMENT_DECLINED_ATTENDEES = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_APPOINTMENT_OBJECT_PROPERTIES_V1, pid = 13u)
    ...
    ///
    let WPD_TASK_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0xE354E95Eu, 0xD8A0us, 0x4637us, 0xA0uy, 0x3Auy, 0x0Cuy, 0xB2uy, 0x68uy, 0x38uy, 0xDBuy, 0xC7uy)
    ...
    let WPD_TASK_PERCENT_COMPLETE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_TASK_OBJECT_PROPERTIES_V1, pid = 8u)
    ...
    let WPD_TASK_REMINDER_DATE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_TASK_OBJECT_PROPERTIES_V1, pid = 10u)
    ...
    ///
    let WPD_SMS_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0x7E1074CCu, 0x50FFus, 0x4DD1us, 0xA7uy, 0x42uy, 0x53uy, 0xBEuy, 0x6Fuy, 0x09uy, 0x3Auy, 0x0Duy)
    ...
    ///
    let WPD_SECTION_OBJECT_PROPERTIES_V1 = 
        new System.Guid(0x516AFD2Bu, 0xC64Eus, 0x44F0us, 0x98uy, 0xDCuy, 0xBEuy, 0xE1uy, 0xC8uy, 0x8Fuy, 0x7Duy, 0x66uy)
    ...
    let WPD_SECTION_DATA_OFFSET = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_SECTION_OBJECT_PROPERTIES_V1, pid = 2u)
    ...
    let WPD_SECTION_DATA_LENGTH = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_SECTION_OBJECT_PROPERTIES_V1, pid = 3u)
    ...
    let WPD_SECTION_DATA_UNITS = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_SECTION_OBJECT_PROPERTIES_V1, pid = 4u)
    ...
    let WPD_SECTION_DATA_REFERENCED_OBJECT_RESOURCE = 
        new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_SECTION_OBJECT_PROPERTIES_V1, pid = 5u)
