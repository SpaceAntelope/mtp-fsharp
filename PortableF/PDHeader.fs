...
/// Represents the entire object's data. There can be only one default resource on an object.
    let WPD_RESOURCE_DEFAULT = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 0u)
///
///  WPD_RESOURCE_CONTACT_PHOTO 
/// Represents the contact's photo data.
    let WPD_RESOURCE_CONTACT_PHOTO = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 0u)
///
///  WPD_RESOURCE_THUMBNAIL 
/// Represents the thumbnail data for an object.
    let WPD_RESOURCE_THUMBNAIL = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 0u)
///
///  WPD_RESOURCE_ICON 
/// Represents the icon data for an object.
    let WPD_RESOURCE_ICON = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 0u)
///
///  WPD_RESOURCE_AUDIO_CLIP 
/// Represents an audio sample data for an object.
    let WPD_RESOURCE_AUDIO_CLIP = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 0u)
///
///  WPD_RESOURCE_ALBUM_ART 
/// Represents the album artwork this media originated from.
    let WPD_RESOURCE_ALBUM_ART = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 0u)
///
///  WPD_RESOURCE_GENERIC 
/// Represents an arbitrary binary blob associated with this object.
    let WPD_RESOURCE_GENERIC = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 0u)
///
///  WPD_RESOURCE_VIDEO_CLIP 
/// Represents a video sample for an object.
    let WPD_RESOURCE_VIDEO_CLIP = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 0u)
///
...
/// Represents the product branding artwork or logo for an object. This resource is typically found on, but not limited to the device object.
    let WPD_RESOURCE_BRANDING_ART = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_CATEGORY_SERVICE_METHODS, pid = 0u)
////
...
///   Recommended Device Services Property: PKEY_GenericObj_ObjectID
    let WPD_OBJECT_ID = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 2u)
///
...
///   Recommended Device Services Property: PKEY_GenericObj_ParentID
    let WPD_OBJECT_PARENT_ID = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 3u)
///
/// WPD_OBJECT_NAME 
///   [ VT_LPWSTR ] The display name for this object.
///   Recommended Device Services Property: PKEY_GenericObj_Name
    let WPD_OBJECT_NAME = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 4u)
///
...
///   Recommended Device Services Property: PKEY_GenericObj_PersistentUID
    let WPD_OBJECT_PERSISTENT_UNIQUE_ID = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 5u)
///
/// WPD_OBJECT_FORMAT 
///   [ VT_CLSID ] Indicates the format of the object's data.
///   Recommended Device Services Property: PKEY_GenericObj_ObjectFormat
    let WPD_OBJECT_FORMAT = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 6u)
///
/// WPD_OBJECT_ISHIDDEN 
///   [ VT_BOOL ] Indicates whether the object should be hidden.
///   Recommended Device Services Property: PKEY_GenericObj_Hidden
    let WPD_OBJECT_ISHIDDEN = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 9u)
///
/// WPD_OBJECT_ISSYSTEM 
...
///   Recommended Device Services Property: PKEY_GenericObj_SystemObject
    let WPD_OBJECT_ISSYSTEM = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 10u)
///
/// WPD_OBJECT_SIZE 
///   [ VT_UI8 ] The size of the object data.
///   Recommended Device Services Property: PKEY_GenericObj_ObjectSize
    let WPD_OBJECT_SIZE = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 11u)
///
...
///   Recommended Device Services Property: PKEY_GenericObj_ObjectFileName
    let WPD_OBJECT_ORIGINAL_FILE_NAME = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 12u)
///
...
///   Recommended Device Services Property: PKEY_GenericObj_NonConsumable
    let WPD_OBJECT_NON_CONSUMABLE = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 13u)
///
/// WPD_OBJECT_KEYWORDS 
...
///   Recommended Device Services Property: PKEY_GenericObj_Keywords
    let WPD_OBJECT_KEYWORDS = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 15u)
///
/// WPD_OBJECT_SYNC_ID 
...
///   Recommended Device Services Property: PKEY_GenericObj_SyncID
    let WPD_OBJECT_SYNC_ID = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 16u)
///
...
///   Recommended Device Services Property: PKEY_GenericObj_DRMStatus
    let WPD_OBJECT_IS_DRM_PROTECTED = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 17u)
///
...
///   Recommended Device Services Property: PKEY_GenericObj_DateCreated
    let WPD_OBJECT_DATE_CREATED = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 18u)
///
...
///   Recommended Device Services Property: PKEY_GenericObj_DateModified
    let WPD_OBJECT_DATE_MODIFIED = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 19u)
///
...
///   Recommended Device Services Property: PKEY_GenericObj_DateAuthored
    let WPD_OBJECT_DATE_AUTHORED = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 20u)
///
/// WPD_OBJECT_BACK_REFERENCES 
///   [ VT_UNKNOWN ] IPortableDevicePropVariantCollection of type VT_LPWSTR indicating a list of ObjectIDs.
///   Recommended Device Services Property: PKEY_GenericObj_ReferenceParentID
    let WPD_OBJECT_BACK_REFERENCES = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 21u)
///
...
///   Recommended Device Services Property: PKEY_GenericObj_ProtectionStatus
    let WPD_OBJECT_CAN_DELETE = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 26u)
///
...
///   Recommended Device Services Property: PKEY_GenericObj_LanguageLocale
    let WPD_OBJECT_LANGUAGE_LOCALE = new PortableDeviceApiLib._tagpropertykey(fmtid = WPD_OBJECT_FORMAT_MKV, pid = 27u)
////
 /// This section defines all Commands, Parameters and Options associated with:
...
///   Recommended Device Services Property: None
    ...
    let GetPropertyName guid pv =
        ...
        | MatchGuids WPD_CATEGORY_SERVICE_METHODS true ->
             ...
             | _ -> (guidName,"Unknown Property")
        | MatchGuids WPD_OBJECT_FORMAT_MKV true ->
             let guidName = "WPD_OBJECT_FORMAT_MKV"
             match pv with
        ...
        | MatchGuids WPD_EVENT_DEVICE_CAPABILITIES_UPDATED true -> ("WPD_EVENT_DEVICE_CAPABILITIES_UPDATED", "No Properties")
        | MatchGuids WPD_EVENT_STORAGE_FORMAT true -> ("WPD_EVENT_STORAGE_FORMAT", "No Properties")
        | MatchGuids WPD_EVENT_OBJECT_TRANSFER_REQUESTED true -> ("WPD_EVENT_OBJECT_TRANSFER_REQUESTED", "No Properties")
        ...
        | MatchGuids WPD_CONTENT_TYPE_MIXED_CONTENT_ALBUM true -> ("WPD_CONTENT_TYPE_MIXED_CONTENT_ALBUM", "No Properties")
        ...
        | MatchGuids WPD_CONTENT_TYPE_NETWORK_ASSOCIATION true -> ("WPD_CONTENT_TYPE_NETWORK_ASSOCIATION", "No Properties")
        ...
        | MatchGuids WPD_FUNCTIONAL_CATEGORY_STILL_IMAGE_CAPTURE true -> ("WPD_FUNCTIONAL_CATEGORY_STILL_IMAGE_CAPTURE", "No Properties")
        | MatchGuids WPD_FUNCTIONAL_CATEGORY_AUDIO_CAPTURE true -> ("WPD_FUNCTIONAL_CATEGORY_AUDIO_CAPTURE", "No Properties")
        | MatchGuids WPD_FUNCTIONAL_CATEGORY_VIDEO_CAPTURE true -> ("WPD_FUNCTIONAL_CATEGORY_VIDEO_CAPTURE", "No Properties")
        | MatchGuids WPD_FUNCTIONAL_CATEGORY_SMS true -> ("WPD_FUNCTIONAL_CATEGORY_SMS", "No Properties")
        | MatchGuids WPD_FUNCTIONAL_CATEGORY_RENDERING_INFORMATION true -> ("WPD_FUNCTIONAL_CATEGORY_RENDERING_INFORMATION", "No Properties")
        | MatchGuids WPD_FUNCTIONAL_CATEGORY_NETWORK_CONFIGURATION true -> ("WPD_FUNCTIONAL_CATEGORY_NETWORK_CONFIGURATION", "No Properties")
        ...
        | MatchGuids WPD_OBJECT_FORMAT_NETWORK_ASSOCIATION true -> ("WPD_OBJECT_FORMAT_NETWORK_ASSOCIATION", "No Properties")
        | MatchGuids WPD_OBJECT_FORMAT_X509V3CERTIFICATE true -> ("WPD_OBJECT_FORMAT_X509V3CERTIFICATE", "No Properties")
        ...
        | MatchGuids WPD_OBJECT_FORMAT_WINDOWSIMAGEFORMAT true -> ("WPD_OBJECT_FORMAT_WINDOWSIMAGEFORMAT", "No Properties")
        ...
        | MatchGuids WPD_OBJECT_FORMAT_ABSTRACT_CONTACT_GROUP true -> ("WPD_OBJECT_FORMAT_ABSTRACT_CONTACT_GROUP", "No Properties")
        | MatchGuids WPD_OBJECT_FORMAT_ABSTRACT_MEDIA_CAST true -> ("WPD_OBJECT_FORMAT_ABSTRACT_MEDIA_CAST", "No Properties")
        ...
        | MatchGuids WPD_OBJECT_FORMAT_MHT_COMPILED_HTML true -> ("WPD_OBJECT_FORMAT_MHT_COMPILED_HTML", "No Properties")
        | MatchGuids WPD_OBJECT_FORMAT_MICROSOFT_EXCEL true -> ("WPD_OBJECT_FORMAT_MICROSOFT_EXCEL", "No Properties")
        | MatchGuids WPD_OBJECT_FORMAT_MICROSOFT_POWERPOINT true -> ("WPD_OBJECT_FORMAT_MICROSOFT_POWERPOINT", "No Properties")
